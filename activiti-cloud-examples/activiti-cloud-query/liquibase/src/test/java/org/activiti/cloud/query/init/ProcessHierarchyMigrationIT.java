 ...
 * ({@code 40-alter.pg.schema.8.9.0.sql}) correctly migrates pre-existing
...
class ProcessHierarchyMigrationIT {
    ...
    private static final String MIGRATION_SCRIPT_PATH = "config/query/liquibase/changelog/40-alter.pg.schema.8.9.0.sql";
