...
ACTIVITI_CLOUD_RB_VERSION := 7.1.289
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.256
ACTIVITI_CLOUD_MODELING :=7.1.472

MODELING_DEPENDENCIES_VERSION := 7.1.264
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.39
