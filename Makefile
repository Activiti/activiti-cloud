...
ACTIVITI_CLOUD_RB_VERSION := 7.1.305
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.270
ACTIVITI_CLOUD_MODELING :=7.1.504

MODELING_DEPENDENCIES_VERSION := 7.1.283
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.63
