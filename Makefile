ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.261
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.250
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.262
ACTIVITI_CLOUD_RB_VERSION := 7.1.311
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.278
ACTIVITI_CLOUD_MODELING :=7.1.519

MODELING_DEPENDENCIES_VERSION := 7.1.294
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.78
