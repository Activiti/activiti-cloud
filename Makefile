ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.253
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.245
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.256
ACTIVITI_CLOUD_RB_VERSION := 7.1.306
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.273
ACTIVITI_CLOUD_MODELING :=7.1.506

MODELING_DEPENDENCIES_VERSION := 7.1.284
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.64
