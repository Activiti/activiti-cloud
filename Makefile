ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.254
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.247
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.257
ACTIVITI_CLOUD_RB_VERSION := 7.1.307
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.273
ACTIVITI_CLOUD_MODELING :=7.1.509

MODELING_DEPENDENCIES_VERSION := 7.1.286
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.67
