ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.247
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.237
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.243
ACTIVITI_CLOUD_RB_VERSION := 7.1.292
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.260
ACTIVITI_CLOUD_MODELING :=7.1.477

MODELING_DEPENDENCIES_VERSION := 7.1.268
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.44
