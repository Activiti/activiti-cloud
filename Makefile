...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.218
ACTIVITI_CLOUD_RB_VERSION := 7.1.263
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.235
ACTIVITI_CLOUD_MODELING :=7.1.445

MODELING_DEPENDENCIES_VERSION := 7.1.237
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.4
