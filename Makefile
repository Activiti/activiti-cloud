...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.214
ACTIVITI_CLOUD_RB_VERSION := 7.1.260
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.227
ACTIVITI_CLOUD_MODELING :=7.1.440

MODELING_DEPENDENCIES_VERSION := 7.1.232
