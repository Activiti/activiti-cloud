...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.220
ACTIVITI_CLOUD_RB_VERSION := 7.1.265
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.237
ACTIVITI_CLOUD_MODELING :=7.1.448

MODELING_DEPENDENCIES_VERSION := 7.1.240
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.8
