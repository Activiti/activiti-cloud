ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.229
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.221
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.211
ACTIVITI_CLOUD_RB_VERSION := 7.1.255
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.222
