...
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.242
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.249
ACTIVITI_CLOUD_RB_VERSION := 7.1.300
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.266
ACTIVITI_CLOUD_MODELING :=7.1.491

MODELING_DEPENDENCIES_VERSION := 7.1.274
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.51
