ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.231
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.224
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.221
ACTIVITI_CLOUD_RB_VERSION := 7.1.266
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.237
ACTIVITI_CLOUD_MODELING :=7.1.450

MODELING_DEPENDENCIES_VERSION := 7.1.242
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.12
