ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.239
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.228
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.231
ACTIVITI_CLOUD_RB_VERSION := 7.1.279
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.248
ACTIVITI_CLOUD_MODELING :=7.1.459

MODELING_DEPENDENCIES_VERSION := 7.1.257
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.29
