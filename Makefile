ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.252
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.244
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.253
ACTIVITI_CLOUD_RB_VERSION := 7.1.304
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.270
ACTIVITI_CLOUD_MODELING :=7.1.503

MODELING_DEPENDENCIES_VERSION := 7.1.282
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.62
