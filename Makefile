...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.240
ACTIVITI_CLOUD_RB_VERSION := 7.1.290
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.257
ACTIVITI_CLOUD_MODELING :=7.1.473

MODELING_DEPENDENCIES_VERSION := 7.1.265
