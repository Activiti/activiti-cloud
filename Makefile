...
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.238
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.244
ACTIVITI_CLOUD_RB_VERSION := 7.1.294
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.262
ACTIVITI_CLOUD_MODELING :=7.1.485

MODELING_DEPENDENCIES_VERSION := 7.1.270
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.46
