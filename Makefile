...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.258
ACTIVITI_CLOUD_RB_VERSION := 7.1.307
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.274
ACTIVITI_CLOUD_MODELING :=7.1.511

MODELING_DEPENDENCIES_VERSION := 7.1.287
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.69
