ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.245
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.234
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.241
ACTIVITI_CLOUD_RB_VERSION := 7.1.291
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.258
ACTIVITI_CLOUD_MODELING :=7.1.474

MODELING_DEPENDENCIES_VERSION := 7.1.266
