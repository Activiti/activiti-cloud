...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.266
ACTIVITI_CLOUD_RB_VERSION := 7.1.316
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.288
ACTIVITI_CLOUD_MODELING :=7.1.532

MODELING_DEPENDENCIES_VERSION := 7.1.298
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.90
