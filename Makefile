...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.251
ACTIVITI_CLOUD_RB_VERSION := 7.1.303
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.268
ACTIVITI_CLOUD_MODELING :=7.1.501

MODELING_DEPENDENCIES_VERSION := 7.1.280
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.59
