ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.255
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.248
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.260
ACTIVITI_CLOUD_RB_VERSION := 7.1.308
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.276
ACTIVITI_CLOUD_MODELING :=7.1.514

MODELING_DEPENDENCIES_VERSION := 7.1.289
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.72
