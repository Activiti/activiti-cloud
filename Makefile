ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.271
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.260
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.272
ACTIVITI_CLOUD_RB_VERSION := 7.1.321
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.293
ACTIVITI_CLOUD_MODELING :=7.1.551

MODELING_DEPENDENCIES_VERSION := 7.1.313
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.105
