...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.238
ACTIVITI_CLOUD_RB_VERSION := 7.1.288
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.255
ACTIVITI_CLOUD_MODELING :=7.1.469

MODELING_DEPENDENCIES_VERSION := 7.1.263
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.38
