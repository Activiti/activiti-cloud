ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.268
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.257
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.268
ACTIVITI_CLOUD_RB_VERSION := 7.1.318
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.290
ACTIVITI_CLOUD_MODELING :=7.1.542

MODELING_DEPENDENCIES_VERSION := 7.1.304
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.98
