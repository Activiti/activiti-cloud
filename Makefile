ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.246
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.236
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.242
ACTIVITI_CLOUD_RB_VERSION := 7.1.291
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.259
ACTIVITI_CLOUD_MODELING :=7.1.476

MODELING_DEPENDENCIES_VERSION := 7.1.267
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.43
