...
ACTIVITI_CLOUD_RB_VERSION := 7.1.301
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.268
ACTIVITI_CLOUD_MODELING :=7.1.496

MODELING_DEPENDENCIES_VERSION := 7.1.277
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.55
