...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.224
ACTIVITI_CLOUD_RB_VERSION := 7.1.270
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.241
ACTIVITI_CLOUD_MODELING :=7.1.451

MODELING_DEPENDENCIES_VERSION := 7.1.243
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.16
