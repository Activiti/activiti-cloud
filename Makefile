...
ACTIVITI_CLOUD_RB_VERSION := 7.1.284
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.250
ACTIVITI_CLOUD_MODELING :=7.1.461

MODELING_DEPENDENCIES_VERSION := 7.1.258
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.31
