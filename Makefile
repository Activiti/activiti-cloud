ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.258
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.249
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.261
ACTIVITI_CLOUD_RB_VERSION := 7.1.309
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.277
ACTIVITI_CLOUD_MODELING :=7.1.517

MODELING_DEPENDENCIES_VERSION := 7.1.292
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.76
