ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.263
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.253
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.263
ACTIVITI_CLOUD_RB_VERSION := 7.1.312
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.282
ACTIVITI_CLOUD_MODELING :=7.1.523

MODELING_DEPENDENCIES_VERSION := 7.1.296
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.83
