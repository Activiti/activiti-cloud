...
ACTIVITI_CLOUD_RB_VERSION := 7.1.318
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.290
ACTIVITI_CLOUD_MODELING :=7.1.544

MODELING_DEPENDENCIES_VERSION := 7.1.306
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.100
