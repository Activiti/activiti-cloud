...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.230
ACTIVITI_CLOUD_RB_VERSION := 7.1.278
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.248
ACTIVITI_CLOUD_MODELING :=7.1.457

MODELING_DEPENDENCIES_VERSION := 7.1.256
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.27
