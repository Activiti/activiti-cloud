ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.242
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.232
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.234
ACTIVITI_CLOUD_RB_VERSION := 7.1.286
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.252
ACTIVITI_CLOUD_MODELING :=7.1.464

MODELING_DEPENDENCIES_VERSION := 7.1.261
