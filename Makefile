ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.244
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.233
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.234
ACTIVITI_CLOUD_RB_VERSION := 7.1.287
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.253
ACTIVITI_CLOUD_MODELING :=7.1.466

MODELING_DEPENDENCIES_VERSION := 7.1.262
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.37
