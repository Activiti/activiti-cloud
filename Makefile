...
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.219
ACTIVITI_CLOUD_RB_VERSION := 7.1.264
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.236
ACTIVITI_CLOUD_MODELING :=7.1.447

MODELING_DEPENDENCIES_VERSION := 7.1.239
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.7
