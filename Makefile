ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.264
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.254
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.265
ACTIVITI_CLOUD_RB_VERSION := 7.1.315
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.283
ACTIVITI_CLOUD_MODELING :=7.1.530

MODELING_DEPENDENCIES_VERSION := 7.1.298
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.88
