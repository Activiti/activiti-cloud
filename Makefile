ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.251
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.243
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.252
ACTIVITI_CLOUD_RB_VERSION := 7.1.303
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.269
ACTIVITI_CLOUD_MODELING :=7.1.502

MODELING_DEPENDENCIES_VERSION := 7.1.281
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.61
