ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.275
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.264
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.275
ACTIVITI_CLOUD_RB_VERSION := 7.1.326
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.296
ACTIVITI_CLOUD_MODELING :=7.1.553

MODELING_DEPENDENCIES_VERSION := 7.1.314
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.110
