...
ACTIVITI_CLOUD_RB_VERSION := 7.1.314
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.283
ACTIVITI_CLOUD_MODELING :=7.1.525

MODELING_DEPENDENCIES_VERSION := 7.1.297
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.85
