...
ACTIVITI_CLOUD_RB_VERSION := 7.1.273
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.244
ACTIVITI_CLOUD_MODELING :=7.1.454

MODELING_DEPENDENCIES_VERSION := 7.1.253
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.24
