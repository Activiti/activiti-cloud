ACTIVITI_CLOUD_CONNECTORS_VERSION := 7.1.267
ACTIVITI_CLOUD_AUDIT_VERSION := 7.1.256
ACTIVITI_CLOUD_QUERY_VERSION := 7.1.267
ACTIVITI_CLOUD_RB_VERSION := 7.1.317
ACTIVITI_CLOUD_NOTIFICATIONS_VERSION := 7.1.290
ACTIVITI_CLOUD_MODELING :=7.1.540

MODELING_DEPENDENCIES_VERSION := 7.1.302
ACTIVITI_CLOUD_ACCEPTANCE_SCENARIOUS_VERSION := 7.1.94
