...
public class EngineEventsMessageProducer implements SmartLifecycle {
    ...
    //    @StreamEmitter
    //    @Output("producer")
    //    public void emit(FluxSender output) throws JsonParseException, JsonMappingException,
    // IOException {
    //        List<Map<String, Object>> events = new ObjectMapper().readValue(json, new
    // TypeReference<List<Map<String,Object>>>(){});
    //
    //        output.send(Flux.interval(Duration.ofMillis(0), Duration.ofMillis(1000),
    // Schedulers.single())
