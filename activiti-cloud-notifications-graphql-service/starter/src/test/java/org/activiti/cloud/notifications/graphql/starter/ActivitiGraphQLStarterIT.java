...
public class ActivitiGraphQLStarterIT {
    ...
    public void testGraphqlWsSubprotocolConnectionInitXAuthorizationSupported()
        ...
        keycloakTokenProducer.setKeycloakTestUser(TESTADMIN);
        final String accessToken = keycloakTokenProducer
    ...
    public void testGraphqlWsSubprotocolServerStartStopSubscription()
        ...
        keycloakTokenProducer.setKeycloakTestUser(TESTADMIN);
        final String auth = keycloakTokenProducer
            .authorizationHeaders()
            .getFirst(AUTHORIZATION);
        ...
        Map<String, Object> variables = mapBuilder()
            ...
            .put(
                "eventTypes",
                Arrays.array("PROCESS_CREATED", "PROCESS_STARTED")
            )
            .get();
        ...
        GraphQLMessage start = GraphQLMessage
            .builder()
                    ...
                    .doOnSubscribe(s ->
                        producerChannel
                            ...
                            .send(
                                MessageBuilder
                                    .withPayload(
                                        Arrays.array(event1, event2, event3)
                                    )
                                    .setHeader("routingKey", "eventProducer")
                                    .build()
                            )
    ...
    public void testGraphqlWhere() {
        ...
        assertThat(
            ((Map<String, Object>) result.getData()).get("ProcessInstances")
        )
            .isNotNull();
    }
 ...
 */
class StringObjectMapBuilder
    extends MapBuilder<StringObjectMapBuilder, String, Object> {}
