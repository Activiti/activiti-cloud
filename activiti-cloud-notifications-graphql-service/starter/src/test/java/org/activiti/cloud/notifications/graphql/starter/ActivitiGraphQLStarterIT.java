...
public class ActivitiGraphQLStarterIT {
    ...
    private static final WebsocketClientSpec graphqlWsClientSpec =
            WebsocketClientSpec.builder().protocols(GRAPHQL_WS).build();
    ...
    @Autowired private EngineEvents producerChannel;
    ...
    public void testGraphqlWsSubprotocolConnectionInitXAuthorizationSupported()
        ...
        final String accessToken =
                keycloakTokenProducer.authorizationHeaders().getFirst(AUTHORIZATION);
        ...
        String ackMessage =
                objectMapper.writeValueAsString(
                        GraphQLMessage.builder().type(GraphQLMessageType.CONNECTION_ACK).build());

        String kaMessage =
                objectMapper.writeValueAsString(
                        GraphQLMessage.builder().type(GraphQLMessageType.KA).build());
    ...
    public void testGraphqlWsSubprotocolServerStartStopSubscription()
                ...
                mapBuilder()
                        .put(
                                ...
                                "subscription($appName: String!, $eventTypes: [EngineEventType!]) {"
                                    ...
                                    + " {     processInstanceId      eventType   } }")
                        .put("variables", variables)
                        .get();

        GraphQLMessage start =
                GraphQLMessage.builder()
        ...
        // given
        CloudProcessCreatedEvent event1 =
                new CloudProcessCreatedEventImpl() {
                    {
        ...
        CloudProcessStartedEvent event2 =
        ...
        client.handle(
                        (i, o) -> {
                            o.sendString(Mono.just(startMessage)).then().log("start").subscribe();
    ...
    private void closeWebSocketAnCompleteDataProcessor(
            ReplayProcessor<String> data, WebsocketOutbound webSocketOutbound) {
    ...
    public void testGraphqlSubscriptionPROCESS_DEPLOYED() throws JsonProcessingException {
        ...
        Map<String, Object> variables =
                new StringObjectMapBuilder().put("appName", "default-app").get();

        Map<String, Object> payload =
                new StringObjectMapBuilder()
                        .put(
                                "query",
                                "subscription($appName: String!) {   engineEvents(appName:"
                                        + " [$appName], eventType: PROCESS_DEPLOYED) {    "
                                        + " processDefinitionKey     eventType   } }")
                        .put("variables", variables)
                        .get();
        GraphQLMessage start =
                GraphQLMessage.builder()
        ...
        // given
        CloudProcessDeployedEvent event1 =
                new CloudProcessDeployedEventImpl(
                        "id", new Date().getTime(), new ProcessDefinitionEntity()) {
                    {
                        setAppName("default-app");
                        setServiceName("rb-my-app");
                        setServiceFullName("serviceFullName");
    ...
    public void testGraphqlSubscriptionSIGNAL_RECEIVED() throws JsonProcessingException {
        ...
        // given
        CloudBPMNSignalReceivedEvent event1 =
    ...
    public void testGraphqlSubscriptionCloudBPMNTimerEvents() throws JsonProcessingException {
        ...
        Map<String, Object> payload =
                new StringObjectMapBuilder()
                        .put(
                                ...
                                "subscription($appName: String!, $eventTypes: [EngineEventType!]) {"
                                    + "   engineEvents(appName: [$appName], eventType: $eventTypes)"
                                    + " {     processInstanceId     processDefinitionId     entity "
                                    + "    eventType   } }")
                        .put("variables", variables)
                        .get();
        GraphQLMessage start =
        ...
        // given
        CloudBPMNTimerScheduledEvent event1 =
        ...
        // given
        CloudBPMNTimerFiredEvent event2 =
        ...
        // given
        CloudBPMNTimerExecutedEvent event3 =
        ...
        // given
        CloudBPMNTimerCancelledEvent event4 =
        ...
        // given
        CloudBPMNTimerFailedEvent event5 =
        ...
        // given
        CloudBPMNTimerRetriesDecrementedEvent event6 =
    ...
    public void testGraphqlSubscriptionCloudBPMNMessageEvents() throws JsonProcessingException {
        ...
        Map<String, Object> variables =
                new StringObjectMapBuilder()
                        ...
                        .put(
                                "eventTypes",
                                Arrays.array("MESSAGE_SENT", "MESSAGE_WAITING", "MESSAGE_RECEIVED"))
                        .get();
    ...
    public void testGraphqlWsSubprotocolServerUnauthorized() throws JsonProcessingException {
        ...
        String initMessage =
                objectMapper.writeValueAsString(
                        GraphQLMessage.builder().type(GraphQLMessageType.CONNECTION_INIT).build());
        HttpClient.create()
                .baseUrl("ws://localhost:" + port)
                .wiretap(true)
        ...
        String expected =
                objectMapper.writeValueAsString(
                        GraphQLMessage.builder().type(GraphQLMessageType.CONNECTION_ERROR).build());
    ...
    public void testGraphql() {
        GraphQLQueryRequest query =
                new GraphQLQueryRequest(
                        "{Tasks(where:{name:{EQ: \""
                                + TASK_NAME
                                + "\"}}){select{id assignee priority}}}");

        ResponseEntity<GraphQLQueryResult> entity =
                rest.postForEntity(
                        GRAPHQL_URL,
    ...
    public void testGraphqlArguments()
        ...
        GraphQLQueryRequest query =
                new GraphQLQueryRequest(
                        "query TasksQuery($name: String!) {Tasks(where:{name:{EQ: $name}})"
                                + " {select{id assignee priority}}}");
