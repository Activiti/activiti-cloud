...
public class GraphiQLAutoConfigurationTest {
    ...
    @Autowired private KeycloakJsonController keycloakJsonController;

    @Autowired private GraphiQLConfigController graphiQLConfigController;
    ...
    public void testContextPath() {
        ...
        assertThat(graphiQLConfigController.appendSegmentToPath("/", "/graphql"))
                .isEqualTo("/graphql");
        assertThat(graphiQLConfigController.appendSegmentToPath(null, "/graphql"))
                .isEqualTo("/graphql");
