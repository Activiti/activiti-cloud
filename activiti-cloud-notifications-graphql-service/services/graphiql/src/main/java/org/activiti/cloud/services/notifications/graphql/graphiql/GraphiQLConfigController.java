...
public class GraphiQLConfigController {
    ...
    @GetMapping(value="${activiti.cloud.notification.uri-prefix:}/graphiql/config.js",  produces = "application/javascript")
    ...
    @GetMapping(value="${activiti.cloud.notification.uri-prefix:}/graphiql/config.json",  produces = MediaType.APPLICATION_JSON_VALUE)
