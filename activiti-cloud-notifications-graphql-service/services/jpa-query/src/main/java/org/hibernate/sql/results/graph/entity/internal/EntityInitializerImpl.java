...
// Temporary fix for https://hibernate.atlassian.net/browse/HHH-20190
// To be removed when the official fix is merged and released: https://github.com/hibernate/hibernate-orm/pull/12019
/**
...
public class EntityInitializerImpl
    ...
    @Nullable
    private final Initializer<?>[] allInitializers;

    @Nullable
    private final Initializer<?>[][] subInitializers;

    @Nullable
    private final Initializer<?>[][] eagerSubInitializers;
        ...
        public EntityInitializerData(EntityInitializerImpl initializer, RowProcessingState rowProcessingState) {
            ...
            if (initializer.isResultInitializer()) {
                ...
                canUseEmbeddedIdentifierInstanceAsEntity =
                    rowProcessingState.getEntityId() != null && initializer.couldUseEmbeddedIdentifierInstanceAsEntity;
            } else {
                uniqueKeyAttributePath = null;
    ...
    public EntityInitializerImpl(
        ...
        isResultInitializer : "Identifier must be fetched, unless this is a result initializer";
        ...
        (discriminatorFetch != null) : "Discriminator should only be fetched if the entity has subclasses";
        ...
        rowIdAssembler = rowIdResult == null ? null : rowIdResult.createResultAssembler(this, creationState);
        ...
        for (int i = 0; i < fetchableCount; i++) {
            ...
            if (subInitializer != null) {
                ...
                if (subInitializer.isEager()) {
                    ...
                    if (
                        fetchParent != null &&
                        fetchParent.containsCollectionFetches() ||
                ...
                stateAssembler instanceof UnfetchedResultAssembler<?> ||
            ...
            if (attributeMetadata.isUpdatable()) {
                updatableAttributeMutabilityPlans[subclassId][stateArrayPosition] =
                    attributeMetadata.getMutabilityPlan();
            }
            for (var subMappingType : declaringType.getSubMappingTypes()) {
                ...
                if (subInitializer != null) {
                    if (subInitializers[subMappingType.getSubclassId()] == null) {
                        ...
                        collectionContainingSubInitializers[subMappingType.getSubclassId()] =
                            new Initializer<?>[fetchableCount];
                    }
    ...
    private static ImmutableBitSet[] toBitSetArray(BitSet[] lazySets) {
        return Arrays.stream(lazySets).map(ImmutableBitSet::valueOfOrEmpty).toArray(ImmutableBitSet[]::new);
    }
    ...
    protected void resolveInstanceSubInitializers(EntityInitializerData data) {
        ...
        if (data.entityHolder.getEntityInitializer() == this) {
            ...
            final var subInitializersToUse = rootEntityDescriptor
        ...
        if (initializers.length == 0) {
            if (hasLazyInitializingSubAssemblers) {
                ...
                for (int i = 0; i < state.length; i++) {
                    ...
                    if (
                        subInstance == UNFETCHED_PROPERTY &&
    ...
    public void initializeInstanceFromParent(Object parentInstance, EntityInitializerData data) {
        ...
        final Object instance = attributeMapping != null ? attributeMapping.getValue(parentInstance) : parentInstance;
        ...
        if (instance == null) {
            ...
            resolveEntityKey(data, data.concreteDescriptor.getIdentifier(entityInstanceForNotify, session));
    ...
    private void deepCopy(EntityPersister containerDescriptor, Object[] source, Object[] target) {
        ...
        for (int i = 0; i < updatableAttributeMutabilityPlan.length; i++) {
            ...
            if (
                updatableAttributeMutabilityPlan[i] != null &&
    ...
    protected void initializeAttributeType(
        Type[] attributeTypes,
        EntityPersister entityDescriptor,
            ...
            if (lazyInitializer == null) {
                ...
                if (data.entityHolder.getManagedObject() == null) {
                    ...
                    if (entity == null) {
                        ...
                        if (proxy != null) {
                            castNonNull(extractLazyInitializer(proxy)).setImplementation(instance);
                        }
                ...
                if (
                    data.concreteDescriptor.getBytecodeEnhancementMetadata().isEnhancedForLazyLoading() &&
                    ...
                    data.setState(
                        data.entityHolder.getEntityInitializer() == null ? State.INITIALIZED : State.RESOLVED
                    );
                }
    ...
    private void resolveEntity(EntityInitializerData data, Object proxy) {
        ...
        if (entity == null) {
            data.entityInstanceForNotify = resolveEntityInstance(data);
            if (proxy != null) {
                castNonNull(extractLazyInitializer(proxy)).setImplementation(data.entityInstanceForNotify);
            }
            data.setState(State.RESOLVED);
        } else {
    ...
    protected Object getEntityFromExecutionContext(EntityInitializerData data) {
        final var executionContext = data
            .getRowProcessingState()
            .getJdbcValuesSourceProcessingState()
            .getExecutionContext();
        return (
                rootEntityDescriptor == executionContext.getRootEntityDescriptor() &&
    ...
    protected void upgradeLockMode(EntityInitializerData data) {
        if (data.lockMode != LockMode.NONE) {
            ...
            if (rowProcessingState.upgradeLocks()) {
                final var entityEntry = data.entityHolder.getEntityEntry();
                assert entityEntry ==
                rowProcessingState.getSession().getPersistenceContextInternal().getEntry(data.entityInstanceForNotify);
                if (entityEntry != null) {
     ...
     */
    private void checkVersion(EntityInitializerData data, EntityEntry entry, RowProcessingState rowProcessingState) {
    ...
    protected Object resolveToOptionalInstance(EntityInitializerData data) {
        if (isResultInitializer()) {
            ...
            final var processingOptions = data
                .getRowProcessingState()
                .getJdbcValuesSourceProcessingState()
    ...
    protected void updateInitializedEntityInstance(EntityInitializerData data) {
        ...
        final var session = rowProcessingState.getSession();
        updateCaches(data, session, session.getPersistenceContextInternal(), state, entityEntry.getVersion());
    }
    ...
    protected void initializeEntityInstance(EntityInitializerData data) {
        ...
        if (isPersistentAttributeInterceptable(entityInstanceForNotify)) {
            final var persistentAttributeInterceptor = asPersistentAttributeInterceptable(entityInstanceForNotify)
                .$$_hibernate_getInterceptor();
            if (
                persistentAttributeInterceptor == null ||
    ...
    protected void updateCaches(
        ...
        if (
            data.concreteDescriptor.canWriteToCache() &&
    ...
    protected void registerNaturalIdResolution(
        ...
        if (entityDescriptor.getNaturalIdMapping() != null) {
            final Object naturalId = entityDescriptor
                .getNaturalIdMapping()
    ...
    private void putInCache(
        ...
        final var cacheEntry = data.concreteDescriptor.buildCacheEntry(
            data.entityInstanceForNotify,
            resolvedEntityState,
            version,
            session
        ...
        if (data.entityHolder.getEntityInitializer() != this) {
            ...
            // todo (6.0): do we really need this check ?
                ...
                if (isPersistentAttributeInterceptable(data.entityInstanceForNotify)) {
                    final var interceptor = asPersistentAttributeInterceptable(data.entityInstanceForNotify)
                        .$$_hibernate_getInterceptor();
    ...
    protected void preLoad(EntityInitializerData data, Object[] resolvedEntityState) {
        ...
        if (session.isEventSource()) {
            final var preLoadEvent = rowProcessingState.getJdbcValuesSourceProcessingState().getPreLoadEvent();
            assert preLoadEvent != null;

            preLoadEvent.reset();

            preLoadEvent
                .setEntity(data.getInstance())
    ...
    public String toString() {
        return "EntityJoinedFetchInitializer(" + toLoggableString(getNavigablePath()) + ")";
    }
