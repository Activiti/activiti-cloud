...
public class EngineEventsTransformerTest {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(
        EngineEventsTransformerTest.class
    );
    ...
    public void setUp() {
        ...
        subject =
            new EngineEventsTransformer(
                Arrays.asList(engineEventAttributeKeys.split(",")),
                eventTypeKey
            );
    }
    ...
    public void transform() throws JsonProcessingException {
        ...
        assertThat(notifications)
            .extracting(EngineEvent::getEventType)
            .containsExactly("type1", "type2", "type2", "type1");
    }
    ...
    @Test
    public void transformFilterMissingAttributes()
