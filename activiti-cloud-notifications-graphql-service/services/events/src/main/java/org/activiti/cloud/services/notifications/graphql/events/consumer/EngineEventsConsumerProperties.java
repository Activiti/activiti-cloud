...
@ConfigurationProperties(
    prefix = "spring.activiti.cloud.services.notifications.graphql.events"
)
public class EngineEventsConsumerProperties {
    ...
    public void setProcessEngineEventAttributeKeys(
        String processEngineEventAttributeKeys
    ) {
