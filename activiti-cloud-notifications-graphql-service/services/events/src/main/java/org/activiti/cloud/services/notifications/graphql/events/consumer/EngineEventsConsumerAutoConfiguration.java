...
@PropertySources(
    {
        ...
        @PropertySource(
            value = "classpath:graphql-events.properties",
...
public class EngineEventsConsumerAutoConfiguration {
    ...
    public static class DefaultEngineEventsConsumerConfiguration {
        ...
        public static final String ENGINE_EVENTS_FLUX_SCHEDULER =
            "engineEventsScheduler";
        private final EngineEventsConsumerProperties properties;

        @Autowired
        public DefaultEngineEventsConsumerConfiguration(
            EngineEventsConsumerProperties properties
        ) {
        ...
        public Transformer engineEventsTransformer() {
            return new EngineEventsTransformer(
                Arrays.asList(
                    properties.getProcessEngineEventAttributeKeys().split(",")
                ),
        ...
        @Bean
        @ConditionalOnMissingBean
        public EngineEventsConsumerMessageHandler engineEventsMessageHandler(
            Transformer engineEventsTransformer
        ) {
            return new EngineEventsConsumerMessageHandler(
        ...
        public Publisher<Message<List<EngineEvent>>> engineEventsPublisher(
            ...
            return IntegrationFlows
                .from(EngineEventsConsumerChannels.SOURCE)
