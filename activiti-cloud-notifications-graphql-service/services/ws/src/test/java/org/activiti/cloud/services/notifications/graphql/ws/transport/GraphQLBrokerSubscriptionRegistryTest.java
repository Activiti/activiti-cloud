...
public class GraphQLBrokerSubscriptionRegistryTest {
    ...
    @Test
    public void testSubscribeGraphQLBrokerChannelSubscriber()
        ...
        assertThat(result.getSubscriber("subscriptionId"))
            .isEqualTo(subscriber);
    }
    ...
    public void testUnsubscribe() throws InterruptedException {
        ...
        AtomicReference<GraphQLBrokerChannelSubscriber> reference = new AtomicReference<>(
            null
        );
        ...
        testSubject.unsubscribe(
            "sessionId",
            subscriber -> reference.set(subscriber)
        );
