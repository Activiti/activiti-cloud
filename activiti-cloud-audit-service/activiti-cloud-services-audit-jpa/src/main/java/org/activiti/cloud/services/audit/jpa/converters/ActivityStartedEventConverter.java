...
public class ActivityStartedEventConverter extends BaseEventToEntityConverter {
    ...
    @Override
    protected ActivityStartedAuditEventEntity createEventEntity(
            CloudRuntimeEvent cloudRuntimeEvent) {
        return new ActivityStartedAuditEventEntity(
                (CloudBPMNActivityStartedEvent) cloudRuntimeEvent);
    }

    @Override
    protected CloudRuntimeEventImpl<?, ?> createAPIEvent(AuditEventEntity auditEventEntity) {
        ActivityStartedAuditEventEntity activityStartedAuditEventEntity =
                (ActivityStartedAuditEventEntity) auditEventEntity;
