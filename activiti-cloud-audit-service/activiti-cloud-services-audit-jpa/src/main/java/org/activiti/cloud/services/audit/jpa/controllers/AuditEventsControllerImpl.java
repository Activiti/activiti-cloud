...
public class AuditEventsControllerImpl implements AuditEventsController {
    ...
    public AuditEventsControllerImpl(
        ...
        this.securityPoliciesApplicationService =
    ...
    public EntityModel<CloudRuntimeEvent<?, CloudRuntimeEventType>> findById(
        ...
        Optional<AuditEventEntity> findResult = eventsRepository.findByEventId(
            eventId
        );
        if (!findResult.isPresent()) {
            throw new NotFoundException(
                "Unable to find event for the given id:'" + eventId + "'"
            );
        }
    ...
    public PagedModel<EntityModel<CloudRuntimeEvent<?, CloudRuntimeEventType>>> findAll(
        ...
        for (AuditEventEntity aee : allAuditInPage.getContent()) {
            ...
            if (converterByEventTypeName != null) {
                ...
                LOGGER.warn(
                    "Converter not found for Event Type: " + aee.getEventType()
                );
            }
        }
