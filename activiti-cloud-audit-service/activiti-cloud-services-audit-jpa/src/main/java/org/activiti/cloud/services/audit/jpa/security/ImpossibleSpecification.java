...
public class ImpossibleSpecification
    ...
    public Predicate toPredicate(
        ...
        Predicate impossibleProcessInstance = criteriaBuilder.equal(
            root.get("processInstanceId"),
            "0"
        );
        Predicate impossibleProcessDefinition = criteriaBuilder.equal(
            root.get("processDefinitionId"),
            "0"
        );

        return criteriaBuilder.and(
            impossibleProcessInstance,
