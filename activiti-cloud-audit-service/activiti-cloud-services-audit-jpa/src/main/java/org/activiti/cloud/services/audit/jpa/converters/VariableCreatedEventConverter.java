...
public class VariableCreatedEventConverter extends BaseEventToEntityConverter {
    ...
    public VariableCreatedEventConverter(
    ...
    @Override
    protected VariableCreatedEventEntity createEventEntity(
        CloudRuntimeEvent cloudRuntimeEvent
    ) {
        return new VariableCreatedEventEntity(
            (CloudVariableCreatedEvent) cloudRuntimeEvent
        );
    }
    ...
    protected CloudRuntimeEventImpl<?, ?> createAPIEvent(
        ...
        return new CloudVariableCreatedEventImpl(
            variableCreatedEventEntity.getEventId(),
