...
public class TaskCompletedEventConverter extends BaseEventToEntityConverter {
    ...
    public TaskCompletedEventConverter(
    ...
    @Override
    protected TaskCompletedEventEntity createEventEntity(
        CloudRuntimeEvent cloudRuntimeEvent
    ) {
        return new TaskCompletedEventEntity(
            (CloudTaskCompletedEvent) cloudRuntimeEvent
        );
    }
