...
public class EventsEngineEventsAdminControllerIT {
    ...
    public void getEvents() throws Exception {
        ...
        given(eventsRepository.findAll(any(PageRequest.class)))
            .willReturn(eventsPage);

        mockMvc
            .perform(
                get("/admin/{version}/events", "v1")
                    .param("page", "1")
                    .param("size", "10")
                    .param("sort", "asc")
            )
    ...
    public void getEventsAlfresco() throws Exception {
        ...
        MvcResult result = mockMvc
            .perform(
                get("/admin/{version}/events?skipCount=11&maxItems=10", "v1")
    ...
    public void headEvents() throws Exception {
        ...
        mockMvc
            .perform(head("/admin/{version}/events", "v1"))
            .andExpect(status().isOk());
    }
    ...
    public void headEventsAlfresco() throws Exception {
        ...
        mockMvc
            .perform(
                head("/admin/{version}/events?skipCount=11&maxItems=10", "v1")
                    .accept(MediaType.APPLICATION_JSON)
            )
            .andExpect(status().isOk());
    }
