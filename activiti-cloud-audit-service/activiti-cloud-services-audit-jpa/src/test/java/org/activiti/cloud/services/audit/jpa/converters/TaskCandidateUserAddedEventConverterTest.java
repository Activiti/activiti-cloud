...
public class TaskCandidateUserAddedEventConverterTest {
    ...
    private TaskCandidateUserAddedEventConverter eventConverter = new TaskCandidateUserAddedEventConverter(
    ...
    public void checkConvertToEntityTaskCandidateUserAddedEvent() {
        ...
        //when
        AuditEventEntity auditEventEntity = eventConverter.convertToEntity(
            event
        );
    ...
    public void checkConvertToAPITaskCandidateUserAddedEvent() {
        //given
        AuditEventEntity auditEventEntity = eventConverter.convertToEntity(
            createTaskCandidateUserAddedEvent()
        );

        //when
        CloudRuntimeEvent cloudEvent = eventConverter.convertToAPI(
            auditEventEntity
        );
        ...
        assertThat(
            ...
            .isEqualTo(
                ((CloudTaskCandidateUserAddedEventImpl) cloudEvent).getEntity()
                    .getTaskId()
            );
        assertThat(
            (
        ...
        assertThat(auditEventEntity.getEntityId())
            .isEqualTo(cloudEvent.getEntityId());
        assertThat(auditEventEntity.getProcessInstanceId())
        ...
        assertThat(auditEventEntity.getBusinessKey())
            .isEqualTo(cloudEvent.getBusinessKey());
        assertThat(auditEventEntity.getParentProcessInstanceId())
    ...
    private CloudTaskCandidateUserAddedEventImpl createTaskCandidateUserAddedEvent() {
        ...
        candidateUserAddedEvent.setParentProcessInstanceId(
