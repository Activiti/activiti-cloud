...
public class TaskCandidatesJpaJsonConverterTest {
    ...
    public void convertToDatabaseColumnShouldReturnTheEntityJsonRepresentation()
        ...
        //when
        String jsonRepresentation = converterCandidateUser.convertToDatabaseColumn(
            candidateUser
        );
        ...
        //when
        jsonRepresentation =
            converterCandidateGroup.convertToDatabaseColumn(candidateGroup);
    ...
    @Test
    public void convertToEntityAttributeShouldCreateTaskCandidate()
        throws Exception {
        //given
        ...
        //when
        TaskCandidateGroup candidateGroup = converterCandidateGroup.convertToEntityAttribute(
            jsonRepresentation
        );
