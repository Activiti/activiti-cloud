...
public class TaskCreatedEventConverterTest {
    ...
    private TaskCreatedEventConverter eventConverter =
            new TaskCreatedEventConverter(new EventContextInfoAppender());
    ...
    public void checkConvertToAPITaskCreatedEvent() {
        ...
        AuditEventEntity auditEventEntity =
                eventConverter.convertToEntity(createTaskCreatedEvent());
