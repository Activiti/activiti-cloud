...
public class AuditEventsControllerImplIT {
    ...
    public void getEvents() throws Exception {
        ...
        Page<AuditEventEntity> eventsPage = new PageImpl<>(
            buildEventsData(1),
            pageable,
            11
        );

        given(eventsRepository.findAll(any(), any(PageRequest.class)))
    ...
    public void headEvents() throws Exception {
        ...
        mockMvc
            .perform(head("/{version}/events", "v1"))
            .andExpect(status().isOk());
    }
    ...
    public void getEventById() throws Exception {
        ...
        given(eventsRepository.findByEventId(anyString()))
            .willReturn(Optional.of(eventEntity));

        mockMvc
            .perform(get("/{version}/events/{id}", "v1", eventEntity.getId()))
            .andExpect(status().isOk());
    }
    ...
    public void headEventById() throws Exception {
        ...
        mockMvc
            .perform(head("/{version}/events/{id}", "v1", eventEntity.getId()))
            .andExpect(status().isOk());
    }
