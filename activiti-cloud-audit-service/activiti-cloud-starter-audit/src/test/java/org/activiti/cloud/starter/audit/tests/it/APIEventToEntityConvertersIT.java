...
public class APIEventToEntityConvertersIT {
    ...
    public void shouldHaveConvertersForAllCoveredEvents() {
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ActivityCancelledEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ActivityCompletedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ActivityStartedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessCancelledEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessCompletedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessCreatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessDeployedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessResumedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessStartedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessSuspendedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ProcessUpdatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(SignalReceivedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(SequenceFlowTakenEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskAssignedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskCancelledEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskCompletedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskCandidateGroupAddedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskCandidateUserAddedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskCreatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskSuspendedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TaskUpdatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(VariableCreatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(VariableDeletedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(VariableUpdatedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TimerFiredEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(TimerScheduledEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(IntegrationRequestedEventConverter.class);
        ...
        assertThat(converter)
            .isNotNull()
            .isInstanceOf(ApplicationDeployedEventConverter.class);
    }
}
