    ...
    public Docket customize(final Docket docket) {
        ResolvedType resourceTypeWithWildCard =
                typeResolver.resolve(
                        CloudRuntimeEvent.class, WildcardType.class, CloudRuntimeEventType.class);

        return docket.alternateTypeRules(
                AlternateTypeRules.newRule(resourceTypeWithWildCard, CloudRuntimeEventModel.class));
    }
}
