...
public class ProcessCandidateStarterGroupRemovedEventConverter extends BaseEventToEntityConverter {

    public ProcessCandidateStarterGroupRemovedEventConverter(EventContextInfoAppender eventContextInfoAppender) {
    ...
    protected CloudRuntimeEventImpl<?, ?> createAPIEvent(AuditEventEntity auditEventEntity) {
        ProcessCandidateStarterGroupRemovedEventEntity eventEntity =
