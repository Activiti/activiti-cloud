...
public class CloudVariableUpdatedEventImpl<T> extends CloudVariableEventImpl
        implements CloudVariableUpdatedEvent {
    ...
    public CloudVariableUpdatedEventImpl(
            String id, Long timestamp, VariableInstance entity, T previousValue) {
