...
public class QueryCloudVariableInstanceImpl extends CloudVariableInstanceImpl implements QueryCloudVariableInstance {

    private boolean ephemeralVariable;

    public QueryCloudVariableInstanceImpl() {}

    public QueryCloudVariableInstanceImpl(boolean ephemeralVariable) {
        this.ephemeralVariable = ephemeralVariable;
    }
