...
public class CloudRuntimeEventTypeTest {
    ...
    private <E extends Enum<E>> List<String> getEnumValuesAsStringList(
        Class<E> enumClass
    ) {
        return EnumSet
            .allOf(enumClass)
    ...
    public void shouldContainAllValueFromEventEnums() {
        List<String> enumValues =
            this.getEnumValuesAsStringList(CloudRuntimeEventType.class);

        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        BPMNActivityEvent.ActivityEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        BPMNErrorReceivedEvent.ErrorEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        BPMNSignalEvent.SignalEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
        ...
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        IntegrationEvent.IntegrationEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(BPMNTimerEvent.TimerEvents.class)
            );
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        BPMNMessageEvent.MessageEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
        ...
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        SequenceFlowEvent.SequenceFlowEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        ProcessRuntimeEvent.ProcessEvents.class
                    )
            );
        assertThat(enumValues)
            .containsAll(
        ...
        assertThat(enumValues)
            .containsAll(
                this.getEnumValuesAsStringList(
                        ApplicationEvent.ApplicationEvents.class
                    )
            );
    }
}
