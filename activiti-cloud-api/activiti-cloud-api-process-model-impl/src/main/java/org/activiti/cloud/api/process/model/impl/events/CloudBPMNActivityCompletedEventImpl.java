...
public class CloudBPMNActivityCompletedEventImpl extends CloudBPMNActivityEventImpl
        implements CloudBPMNActivityCompletedEvent {

    public CloudBPMNActivityCompletedEventImpl() {}

    public CloudBPMNActivityCompletedEventImpl(
            BPMNActivity entity, String processDefinitionId, String processInstanceId) {
