...
public class CloudIntegrationExecutedEventImpl extends CloudRuntimeEventImpl<IntegrationContext, IntegrationEvent.IntegrationEvents>
        implements CloudIntegrationExecutedEvent {

    private static final long serialVersionUID = 1L;

    public CloudIntegrationExecutedEventImpl() {
    }

    public CloudIntegrationExecutedEventImpl(IntegrationContext integrationContext) {
    ...
    public IntegrationEvent.IntegrationEvents getEventType() {
        return IntegrationEvent.IntegrationEvents.INTEGRATION_EXECUTED;
    }
}
