...
public class CloudStartMessageDeployedEventImpl
    ...
    public CloudStartMessageDeployedEventImpl(
            String id, Long timestamp, StartMessageDeploymentDefinition entity) {
    ...
    /**
     * Creates a builder to build {@link CloudStartMessageDeployedEventImpl} and initialize it with
     * the given object.
     *
