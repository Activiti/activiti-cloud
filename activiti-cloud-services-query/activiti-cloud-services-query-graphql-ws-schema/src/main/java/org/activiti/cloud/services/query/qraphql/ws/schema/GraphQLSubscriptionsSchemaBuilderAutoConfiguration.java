...
public class GraphQLSubscriptionsSchemaBuilderAutoConfiguration {
    ...
    public static class DefaultGraphQLSubscriptionsSchemaConfiguration {
        ...
        public GraphQLSubscriptionSchemaBuilder graphqlSchemaBuilder() {
            GraphQLSubscriptionSchemaBuilder schemaBuilder = new GraphQLSubscriptionSchemaBuilder(properties.getGraphqls());
