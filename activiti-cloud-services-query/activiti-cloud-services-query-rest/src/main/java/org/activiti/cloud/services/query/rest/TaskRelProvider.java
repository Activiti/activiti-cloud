...
public class TaskRelProvider implements RelProvider {

    public static final String COLLECTION_RESOURCE_REL = "tasks";

    private static final String ITEM_RESOURCE_REL = "task";
