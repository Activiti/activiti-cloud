...
public class ProcessInstanceRelProvider implements RelProvider {

    public static final String COLLECTION_RESOURCE_REL = "process-instances";

    private static final String ITEM_RESOURCE_REL = "process-instance";
