...
public class TaskCandidateGroupAddedEventHandlerTest {
...
//        TaskCandidateGroupAddedEvent taskCreated = new TaskCandidateGroupAddedEvent(System.currentTimeMillis(),
...
//
//        //then
//        assertThat(handledEventClass).isEqualTo(TaskCandidateGroupAddedEvent.class);
//    }
}