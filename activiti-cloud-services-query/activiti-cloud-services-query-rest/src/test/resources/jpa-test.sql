...
insert into taskEntity (id, assignee, category, create_time, description, due_date, last_modified, last_modified_from, last_modified_to, name, priority, process_definition_id, process_instance_id, status, owner, claim_date) values
...
insert into variableEntity (create_time, execution_id, last_updated_time, name, process_instance_id, task_id, type, value) values
