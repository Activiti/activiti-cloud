 ...
 *
 * <p>Disabled at startup unless {@code activiti.cloud.query.pushed-counts.enabled=true}, in which
 * case none of this class's beans are created and
 * {@code WebSocketMessageBrokerSecurityAutoConfiguration}'s plain interceptor is used instead.
 * Actual count delivery is a separate, runtime-toggleable switch - see {@link PushedCountDataFetcher}.
 */
