...
public interface ProcessInstanceRepository
    ...
    default void customize(QuerydslBindings bindings, QProcessInstanceEntity root) {
        ...
        bindings.bind(root.initiator)
                .first((path, value) -> root.initiator.in(Arrays.asList(value.split(","))));
        bindings.bind(root.appVersion)
                .first((path, value) -> root.appVersion.in(Arrays.asList(value.split(","))));
    }
}
