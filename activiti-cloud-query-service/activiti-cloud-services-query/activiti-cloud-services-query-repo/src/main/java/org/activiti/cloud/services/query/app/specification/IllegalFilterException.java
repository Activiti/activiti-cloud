...
public class IllegalFilterException extends RuntimeException {
    ...
    public IllegalFilterException(VariableType type, FilterOperator operator, String value) {
        super("Illegal filter for variable type %s. Operator: %s, value: %s".formatted(type, operator, value));
    }
}
