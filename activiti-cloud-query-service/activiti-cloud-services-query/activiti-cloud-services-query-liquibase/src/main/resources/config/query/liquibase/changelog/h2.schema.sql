...
create index idx_process_instance_initiator_status on process_instance(initiator, status);
...
create index idx_task_dueDate on task (due_date);
create index idx_proc_var_defKey_name on process_variable (process_definition_key, name);
