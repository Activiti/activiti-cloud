...
public class ListOfStackTraceElementsJsonConverterTest {
    ...
    private ListOfStackTraceElementsJsonConverter converter = new ListOfStackTraceElementsJsonConverter();
    ...
    public void convertToDatabaseColumnShouldReturnTheEntityJsonRepresentation()
        ...
        assertThatJson(jsonRepresentation)
            .node("[0].methodName")
            .isEqualTo(
                "convertToDatabaseColumnShouldReturnTheEntityJsonRepresentation"
            );
    }
    ...
    public void convertToEntityAttributeShouldCreateAProcessInstanceWithFieldsSet()
        ...
        //when
        List<StackTraceElement> stackTraceElements = converter.convertToEntityAttribute(
            jsonRepresentation
        );
