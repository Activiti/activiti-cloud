...
public class ListOfStackTraceElementsJsonConverterTest {
    ...
    private ListOfStackTraceElementsJsonConverter converter =
            new ListOfStackTraceElementsJsonConverter();
    ...
    public void convertToDatabaseColumnShouldReturnTheEntityJsonRepresentation() throws Exception {
        ...
        String jsonRepresentation =
                converter.convertToDatabaseColumn(Arrays.asList(error.getStackTrace()));
    ...
    public void convertToEntityAttributeShouldCreateAProcessInstanceWithFieldsSet()
        ...
        List<StackTraceElement> stackTraceElements =
                converter.convertToEntityAttribute(jsonRepresentation);
