...
class IntegrationErrorReceivedEventHandlerTest extends IntegrationEventsHelper {
    ...
    void handleShouldUpdateStatusesWhenIntegrationErrorReceived() {
        ...
        // when
        CloudIntegrationErrorReceivedEvent resultEvent = buildIntegrationErrorReceivedEvent(id);
        errorHandler.handle(resultEvent);
        ...
        assertThat(updatedIntegrationContext.getStatus())
            .isEqualTo(IntegrationContextStatus.INTEGRATION_ERROR_RECEIVED);
        assertThat(updatedIntegrationContext.getErrorDate()).isNotNull();

        assertThat(updatedServiceTask.getStatus()).isEqualTo(BPMNActivityStatus.ERROR);
        assertThat(updatedServiceTask.getCompletedDate()).isNull();
    }
    ...
    void handleShouldUpdateStatusesForLegacyIdsWhenIntegrationResultReceived() {
        ...
        // when
        CloudIntegrationErrorReceivedEvent resultEvent = buildIntegrationErrorReceivedEvent(newUuid);
        errorHandler.handle(resultEvent);
    ...
    private CloudIntegrationErrorReceivedEvent buildIntegrationErrorReceivedEvent(String integrationContextId) {
