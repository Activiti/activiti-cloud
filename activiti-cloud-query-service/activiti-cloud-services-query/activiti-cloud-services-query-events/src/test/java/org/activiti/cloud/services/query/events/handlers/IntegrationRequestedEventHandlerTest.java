...
public class IntegrationRequestedEventHandlerTest {
    ...
    @Test
    public void handleShouldMoveExternalizedContextReferenceFromContextToEntity() {
        ...
        integrationContext.setExternalizedContextReference(
            new ExternalizedContextReferenceImpl("temp-storage", "https://temp-storage/blobs")
        );
        ...
        assertThat(entity.getExternalizedContextReference()).isNotNull();
        assertThat(entity.getExternalizedContextReference().getProviderType()).isEqualTo("temp-storage");
        assertThat(entity.getExternalizedContextReference().getUrl()).isEqualTo("https://temp-storage/blobs");
    }

    @Test
    public void handleShouldLeaveExternalizedContextReferenceNullWhenAbsentFromContext() {
        IntegrationContextImpl integrationContext = new IntegrationContextImpl();
        integrationContext.setProcessInstanceId("procInst");
        integrationContext.setClientId("client");
        integrationContext.setExecutionId("exec");
        ...
        assertThat(captor.getValue().getExternalizedContextReference()).isNull();
    }
}
