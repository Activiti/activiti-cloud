...
public class QueryEventHandlerContextOptimizer {
    ...
    private Map<Class<? extends CloudRuntimeEvent>, Integer> order =
         Map.ofEntries(Map.entry(CloudProcessCreatedEventImpl.class, 0),
                       ...
                       Map.entry(CloudTaskActivatedEventImpl.class, 3),
                       Map.entry(CloudTaskSuspendedEventImpl.class, 3),
                       Map.entry(CloudTaskAssignedEventImpl.class, 3),
                       Map.entry(CloudTaskUpdatedEventImpl.class, 3),
                       Map.entry(CloudTaskCandidateUserAddedEventImpl.class, 3),
                       Map.entry(CloudTaskCandidateUserRemovedEventImpl.class, 3),
                       Map.entry(CloudTaskCandidateGroupAddedEventImpl.class, 3),
                       Map.entry(CloudTaskCandidateGroupRemovedEventImpl.class, 3),
                       Map.entry(CloudVariableCreatedEventImpl.class, 4),
                       Map.entry(CloudVariableUpdatedEventImpl.class, 5),
                       Map.entry(CloudVariableDeletedEventImpl.class, 6),
                       Map.entry(CloudTaskCompletedEventImpl.class, 7),
                       Map.entry(CloudTaskCancelledEventImpl.class, 7),
                       Map.entry(CloudProcessCompletedEventImpl.class, 7),
                       Map.entry(CloudProcessCancelledEventImpl.class, 7));
    ...
    public List<CloudRuntimeEvent<?,?>> optimize(List<CloudRuntimeEvent<?, ?>> events) {
        ...
        return events.stream()
                     .sorted(Comparator.comparing(event -> order.getOrDefault(event.getClass(), 0)))
