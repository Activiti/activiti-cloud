...
public class TaskController {
    ...
    public EntityModel<QueryCloudTask> findById(@PathVariable String taskId) {
        ...
        boolean canUserViewTask = taskControllerHelper.canUserViewTask(
        ...
        if (!canUserViewTask) {
            ...
            throw new ActivitiForbiddenException(
                "Operation not permitted for " + taskId
            );
        }
