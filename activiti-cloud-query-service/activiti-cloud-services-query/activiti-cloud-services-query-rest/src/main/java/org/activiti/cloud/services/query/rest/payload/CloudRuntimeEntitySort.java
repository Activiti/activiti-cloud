...
public record CloudRuntimeEntitySort(
    String field, Sort.Direction direction, boolean isProcessVariable, Collection<String> processDefinitionKey, VariableType type
) {
    /**
    ...
    public CloudRuntimeEntitySort(
        ...
        Collection<String> processDefinitionKey,
        VariableType type
    ) {
        this(
            field,
