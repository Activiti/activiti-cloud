...
public class ProcessInstanceServiceTasksController {
    ...
    @Autowired
    public ProcessInstanceServiceTasksController(TaskRepository taskRepository,
    ...
    public PagedModel<EntityModel<CloudTask>> getTasks(@PathVariable String processInstanceId,
                                                       Pageable pageable) {
        Page<TaskEntity> page = taskRepository.findAll(QBPMNActivityEntity.bPMNActivityEntity.processInstanceId.eq(processInstanceId),
                                                       pageable);
