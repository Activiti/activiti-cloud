...
@RestController
@RequestMapping(
    value = "/admin/v1/process-instances/{processInstanceId}/bpmn-activities",
    produces = { MediaTypes.HAL_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE }
)
public class ProcessInstanceBpmnActivitiesAdminController {
    ...
    public ProcessInstanceBpmnActivitiesAdminController(
