...
public class DateVariableValueCondition extends VariableValueCondition {
    ...
    protected String getFunctionName() {
        return switch (operator) {
            case EQUALS -> JsonValueFunctions.DATE_EQUALS;
            case GREATER_THAN -> JsonValueFunctions.DATE_GREATER_THAN;
            case GREATER_THAN_OR_EQUAL -> JsonValueFunctions.DATE_GREATER_THAN_EQUAL;
            case LESS_THAN -> JsonValueFunctions.DATE_LESS_THAN;
            case LESS_THAN_OR_EQUAL -> JsonValueFunctions.DATE_LESS_THAN_EQUAL;
