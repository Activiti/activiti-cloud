...
public class ProcessInstanceVariableAdminController {
    ...
    private AlfrescoPagedModelAssembler<ProcessVariableEntity>
            pagedVariablesCollectionModelAssembler;

    private VariableRepository variableRepository;

    private ProcessInstanceVariableRepresentationModelAssembler
    ...
    public ProcessInstanceVariableAdminController(
            ...
            ProcessInstanceVariableRepresentationModelAssembler
                    variableRepresentationModelAssembler,
            AlfrescoPagedModelAssembler<ProcessVariableEntity>
                    pagedVariablesCollectionModelAssembler) {
