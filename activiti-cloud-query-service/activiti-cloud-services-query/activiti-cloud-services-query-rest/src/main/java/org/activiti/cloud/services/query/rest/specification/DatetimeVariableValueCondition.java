...
public class DatetimeVariableValueCondition extends VariableValueCondition {
    ...
    public Expression getExtractedValue() {
        return criteriaBuilder
            .function(CustomPostgreSQLDialect.EXTRACT_JSON_STRING_VALUE, LocalDateTime.class, variableValuePath)
            .as(LocalDateTime.class);
    }

    @Override
    protected Expression getConvertedValue() {
        return criteriaBuilder.literal(filterValue).as(LocalDateTime.class);
    }
}
