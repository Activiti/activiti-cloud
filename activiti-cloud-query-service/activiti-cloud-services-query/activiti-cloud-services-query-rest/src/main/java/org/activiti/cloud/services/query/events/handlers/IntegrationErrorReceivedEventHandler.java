...
public class IntegrationErrorReceivedEventHandler implements QueryEventHandler {
    ...
    public IntegrationErrorReceivedEventHandler(BPMNActivityRepository activitiyRepository,
    ...
    public void handle(CloudRuntimeEvent<?, ?> event) {
        ...
        bpmnActivityEntity.setErrorDate(new Date(integrationEvent.getTimestamp()));
