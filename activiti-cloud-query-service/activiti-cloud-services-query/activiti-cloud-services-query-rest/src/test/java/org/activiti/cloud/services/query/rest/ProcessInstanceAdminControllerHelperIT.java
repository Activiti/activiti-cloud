...
public class ProcessInstanceAdminControllerHelperIT {
    ...
    public void shouldReturnAllProcessInstanceAdminWithSubprocess() {
        ...
        assertThat(returnedParentProcessInstance.getSubprocesses()).anyMatch(subprocess ->
    ...
    public void shouldReturnAllProcessInstanceAdminWithVariables() {
        ...
        Page<ProcessInstanceEntity> result = processInstanceAdminControllerHelper
                .findAllProcessInstanceAdminWithVariables(
                        predicate,
                        variableKeys,
                        pageable);
    ...
    public void shouldReturnProcessAdminById() {
        ...
        assertThat(result.getSubprocesses().stream().anyMatch(subprocess -> subprocess.getId().equals(subprocessInstance.getId()))).isTrue();
    }
