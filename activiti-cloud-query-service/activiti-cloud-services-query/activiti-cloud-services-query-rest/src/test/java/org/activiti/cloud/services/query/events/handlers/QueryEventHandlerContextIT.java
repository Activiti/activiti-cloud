...
public class QueryEventHandlerContextIT {
    ...
    public void shouldHaveHandlersForAllSupportedEvents() {
        ...
        assertThat(handlers.get(ProcessDefinitionEvent.ProcessDefinitionEvents.PROCESS_DEPLOYED.name()))
        ...
        assertThat(handlers.get(ProcessRuntimeEvent.ProcessEvents.PROCESS_DELETED.name()))
            .isInstanceOf(ProcessDeletedEventHandler.class);
        ...
        assertThat(handlers.get(TaskCandidateUserEvent.TaskCandidateUserEvents.TASK_CANDIDATE_USER_ADDED.name()))
            .isInstanceOf(TaskCandidateUserAddedEventHandler.class);
        assertThat(handlers.get(TaskCandidateGroupEvent.TaskCandidateGroupEvents.TASK_CANDIDATE_GROUP_ADDED.name()))
            .isInstanceOf(TaskCandidateGroupAddedEventHandler.class);
        assertThat(handlers.get(TaskCandidateUserEvent.TaskCandidateUserEvents.TASK_CANDIDATE_USER_REMOVED.name()))
            .isInstanceOf(TaskCandidateUserRemovedEventHandler.class);
        assertThat(handlers.get(TaskCandidateGroupEvent.TaskCandidateGroupEvents.TASK_CANDIDATE_GROUP_REMOVED.name()))
        ...
        assertThat(
            ...
            .isInstanceOf(ProcessCandidateStarterUserAddedEventHandler.class);
        assertThat(
            handlers.get(
                ProcessCandidateStarterUserEvent.ProcessCandidateStarterUserEvents.PROCESS_CANDIDATE_STARTER_USER_REMOVED.name()
            )
        )
            .isInstanceOf(ProcessCandidateStarterUserRemovedEventHandler.class);
        assertThat(
            handlers.get(
                ProcessCandidateStarterGroupEvent.ProcessCandidateStarterGroupEvents.PROCESS_CANDIDATE_STARTER_GROUP_ADDED.name()
            )
        )
            .isInstanceOf(ProcessCandidateStarterGroupAddedEventHandler.class);
        assertThat(
            handlers.get(
                ProcessCandidateStarterGroupEvent.ProcessCandidateStarterGroupEvents.PROCESS_CANDIDATE_STARTER_GROUP_REMOVED.name()
            )
        )
            .isInstanceOf(ProcessCandidateStarterGroupRemovedEventHandler.class);
    }
}
