...
public class TaskEntityVariableEntityControllerIT {
    ...
    @MockBean private TaskVariableRepository variableRepository;
    ...
    @Test
    public void
            getVariablesShouldReturnAllResultsUsingAlfrescoMetadataWhenMediaTypeIsApplicationJson()
                    throws Exception {
        // given
        ...
        MvcResult result =
                mockMvc.perform(
                                get(
                                                "/v1/tasks/{taskId}/variables?skipCount=11&maxItems=10",
    ...
    @Test
    public void getVariablesShouldReturnAllResultsUsingHalWhenMediaTypeIsApplicationHalJson()
            throws Exception {
        // given
        ...
        mockMvc.perform(
                        get(
                                        "/v1/tasks/{taskId}/variables?page=1&size=10",
                                        variableEntity.getTaskId())
