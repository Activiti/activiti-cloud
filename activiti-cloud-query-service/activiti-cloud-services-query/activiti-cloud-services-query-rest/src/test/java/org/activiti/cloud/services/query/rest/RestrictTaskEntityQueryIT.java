...
public class RestrictTaskEntityQueryIT {
    ...
    private void shouldGetTasksWhenCandidateRestrictToInvolvedUser() {
        ...
        Iterable<TaskEntity> iterable = taskRepository.findInProcessInstanceScope(
            predicate
        );
        assertThat(iterable.iterator().hasNext()).isTrue();
    }
    ...
    public void shouldGetTasksAssignedToSomeOneElseWhenOwner() {
        ...
        shouldGetTasksAssignedToSomeOneElseWhenOwner_RestrictTaskQuery(
            taskEntity.getId()
        );
        shouldGetTasksAssignedToSomeOneElseWhenOwner_RestrictToInvolvedUser(
            taskEntity.getId()
        );
    }

    private void shouldGetTasksAssignedToSomeOneElseWhenOwner_RestrictTaskQuery(
        String taskId
    ) {
        Predicate predicate = taskLookupRestrictionService.restrictTaskQuery(
            null
