...
public class ProcessQueryAdminSteps {
    ...
    public String getProcessModel(String processDefinitionId) {
        return processModelQueryAdminService.getProcessModel(
            processDefinitionId
        );
    }
    ...
    @Step
    public PagedModel<CloudServiceTask> getServiceTasksByQuery(
    ...
    @Step
    public PagedModel<CloudServiceTask> getServiceTasksByStatus(
        String processInstanceId,
        String status
    ) {
        return processQueryAdminService.getServiceTasksByStatus(
            processInstanceId,
            status
        );
    }
    ...
    @Step
    public CloudIntegrationContext getCloudIntegrationContext(
        String serviceTaskId
    ) {
        return processQueryAdminService.getCloudIntegrationContext(
            serviceTaskId
        );
    }
}
