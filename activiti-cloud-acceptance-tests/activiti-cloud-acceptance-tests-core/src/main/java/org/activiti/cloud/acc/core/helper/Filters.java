...
public class Filters {
    ...
    public static Collection<CloudProcessInstance> checkProcessInstances(
            PagedModel<CloudProcessInstance> resource, String processKey) {
    ...
    public static Collection<CloudProcessInstance> checkProcessInstances(
            Collection<CloudProcessInstance> resource, String processKey) {
        Collection<CloudProcessInstance> filteredCollection = new ArrayList<>();
    ...
    public static Collection<CloudRuntimeEvent> checkEvents(
            Collection<CloudRuntimeEvent> rawCollection, String processKey) {
        ...
        for (CloudRuntimeEvent e : rawCollection) {
            ...
            if (element instanceof ProcessInstanceImpl
                ...
                if ((((ProcessInstanceImpl) element)
