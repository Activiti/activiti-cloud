...
/**
 * Mirrors Serenity `ProcessDefinitionActions#getProcessDefinition` — picks the deployed
 * process definition with the highest `appVersion` among entries matching `key`.
 */
