...
| [PARALLEL_SAFE.md](PARALLEL_SAFE.md)             | Isolation rules, Playwright project order (`dependencies`)  |
| [../../activiti-cloud-acceptance-scenarios/DEPRECATED.md](../../activiti-cloud-acceptance-scenarios/DEPRECATED.md) | Remaining Serenity stories vs Playwright specs |
