...
#   --name NAME        Environment name (default: activiti-tests) → namespace pr-NAME-rabbit-n-d
...
INSTALL_MODE="auto"
KUBECONFIG_ARG=""
ENV_NAME="${ACCEPTANCE_ENV_NAME:-activiti-tests}"
...
echo "   npm run port-forward    # terminal 1 (or rely on global-setup)"
