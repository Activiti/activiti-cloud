    ...
    post {
        failure {
           slackSend(
             ...
             color: "danger",
             message: "activiti-cloud-service-common branch=$BRANCH_NAME is failed http://jenkins.jx.35.242.205.159.nip.io/job/Activiti/job/activiti-cloud-service-common"
           )
        } 
        always {
            cleanWs()
