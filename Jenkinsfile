      ...
      stage('Build Release') {
        ...
        steps {
          ...
          container('maven') {
            ...
            sh "make update-ea"
            slackSend(channel: "@Alex Merkulov", message: "New build propogated to AE https://git.alfresco.com/process-services/alfresco-process-parent/merge_requests", sendAsText: true)  
