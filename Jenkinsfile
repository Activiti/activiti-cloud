    ...
    post {
        failure {
           slackSend(
             ...
             color: "danger",
             message: "activiti-cloud-runtime-bundle-service branch=$BRANCH_NAME is failed http://jenkins.jx.35.242.205.159.nip.io/job/Activiti/job/activiti-cloud-runtime-bundle-service/"
           )
        } 
        always {
            cleanWs()
