...
public class MessageCoreAutoConfigurationTest {
    ...
    @Autowired private MessageConnectorProcessor messageConnectorProcessor;

    @Autowired private IntegrationFlow messageConnectorIntegrationFlow;
    ...
    public void contextLoads() {
        ...
        assertProperty("spring.cloud.stream.bindings.messageConnectorInput.destination")
                .isEqualTo("messageEvents");
        assertProperty("spring.cloud.stream.bindings.messageConnectorOutput.destination")
                .isEqualTo("commandConsumer");
    }
