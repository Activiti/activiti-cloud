...
public class MessageCoreAutoConfigurationTest {
    ...
    public void contextLoads() {
        ...
        assertProperty("spring.cloud.stream.bindings.messageConnectorInput.destination").isEqualTo("messageEvents_my-activiti-rb-app");
        assertProperty("spring.cloud.stream.bindings.messageConnectorOutput.destination").isEqualTo("commandConsumer_my-activiti-rb-app");
    }
