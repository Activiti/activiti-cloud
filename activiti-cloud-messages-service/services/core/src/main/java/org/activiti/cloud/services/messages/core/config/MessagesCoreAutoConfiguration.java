...
@PropertySource(
    "classpath:config/activiti-cloud-services-messages-core.properties"
)
public class MessagesCoreAutoConfiguration {
    ...
    public CommandConsumerDestinationMapper commandConsumerDestinationMapper(
        ...
        return new CommandConsumerDestinationMapper(
            properties.getDestinationSeparator()
        );
    }
    ...
    public CommandConsumerMessageChannelResolver commandConsumerMessageChannelResolver(
        ...
        return new CommandConsumerMessageChannelResolver(
            commandConsumerDestinationMapper,
    ...
    public MessageProcessor<String> metadataStoreKeyStrategy() {
        return m ->
            Optional
                .ofNullable(
                    m.getHeaders().get(MessageEventHeaders.MESSAGE_EVENT_ID)
                )
                .map(Object::toString)
    ...
    public MessageConnectorHandlerAdvice messageReceivedHandlerAdvice(
        ...
        return new MessageReceivedHandlerAdvice(
            messageStore,
            correlationStrategy,
            lockTemplate
        );
    ...
    public MessageGroupProcessor messageConnectorPayloadGroupProcessor(
        ...
        return new MessageGroupProcessorHandlerChain(
            messageGroupProcessorChain
        );
    }

    @Bean
    @ConditionalOnMissingBean
    public MessageGroupReleaseChain messageGroupReleaseChain(
        MessageGroupStore messageGroupStore
    ) {
        return ChainBuilder
            .of(MessageGroupReleaseChain.class)
