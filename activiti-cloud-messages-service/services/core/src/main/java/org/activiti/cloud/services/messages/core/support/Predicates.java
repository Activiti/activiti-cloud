...
public class Predicates {
    ...
    public static Predicate<Message<?>> MESSAGE_WAITING =
            predicate(new MessageEventTypeSelector(MessageEvents.MESSAGE_WAITING)::accept);
    public static Predicate<Message<?>> MESSAGE_RECEIVED =
            predicate(new MessageEventTypeSelector(MessageEvents.MESSAGE_RECEIVED)::accept);
    public static Predicate<Message<?>> MESSAGE_SENT =
            predicate(new MessageEventTypeSelector(MessageEvents.MESSAGE_SENT)::accept);
    public static Predicate<Message<?>> MESSAGE_SUBSCRIPTION_CANCELLED =
            predicate(
                    new MessageEventTypeSelector(
                                    MessageSubscriptionEvents.MESSAGE_SUBSCRIPTION_CANCELLED)
                            ::accept);
    public static Predicate<Message<?>> START_MESSAGE_DEPLOYED =
            predicate(
                    new MessageEventTypeSelector(MessageDefinitionEvents.START_MESSAGE_DEPLOYED)
                            ::accept);
