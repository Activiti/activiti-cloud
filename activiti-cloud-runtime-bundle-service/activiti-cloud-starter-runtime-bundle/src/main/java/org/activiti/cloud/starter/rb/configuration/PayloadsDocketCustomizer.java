...
public class PayloadsDocketCustomizer implements DocketCustomizer {
    ...
    public static class StartProcessPayloadApiModel
        extends StartProcessPayload {
    ...
    public static class UpdateProcessPayloadApiModel
        extends UpdateProcessPayload {
    ...
    public static class SetProcessVariablesPayloadApiModel
        extends SetProcessVariablesPayload {
    ...
    public static class CandidateGroupsPayloadApiModel
        extends CandidateGroupsPayload {
    ...
    public static class CandidateUsersPayloadApiModel
        extends CandidateUsersPayload {
    ...
    public static class CompleteTaskPayloadApiModel
        extends CompleteTaskPayload {
    ...
    public static class CreateTaskVariablePayloadApiModel
        extends CreateTaskVariablePayload {
    ...
    public static class UpdateTaskVariablePayloadApiModel
        extends UpdateTaskVariablePayload {
    ...
    public static class CreateProcessInstancePayloadApiModel
        extends CreateProcessInstancePayload {
