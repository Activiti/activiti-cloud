...
public class ActivitiAuditProducerEnvironmentPostProcessor
    ...
    private static final Logger logger = LoggerFactory.getLogger(
        ActivitiAuditProducerEnvironmentPostProcessor.class
    );
    ...
    public void postProcessEnvironment(
        ...
        Optional<Boolean> isPartitioned = Optional.ofNullable(
            environment.getProperty(
                ACTIVITI_CLOUD_MESSAGING_PARTITIONED,
                Boolean.class
            )
        );

        logger.warn(
            "Configuring " + ACTIVITI_CLOUD_MESSAGING_PARTITIONED + "={}",
            isPartitioned
        );

        Integer partitionCount = environment.getProperty(
            ACTIVITI_CLOUD_MESSAGING_PARTITION_COUNT,
            Integer.class
        );
