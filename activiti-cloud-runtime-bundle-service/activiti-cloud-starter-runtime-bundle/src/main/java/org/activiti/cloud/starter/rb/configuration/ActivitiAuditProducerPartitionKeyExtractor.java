...
public class ActivitiAuditProducerPartitionKeyExtractor
    ...
    public Object extractKey(Message<?> message) {
        ...
        String rootProcessInstance = message
            .getHeaders()
            .get(ROOT_PROCESS_INSTANCE_ID, String.class);

        return Optional
            .ofNullable(rootProcessInstance)
