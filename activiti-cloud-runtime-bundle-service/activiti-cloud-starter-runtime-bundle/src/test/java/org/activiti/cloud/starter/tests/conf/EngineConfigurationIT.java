...
public class EngineConfigurationIT {
        ...
        assertThat(bindings)
            ...
            .contains(
                ...
                entry(
                    ...
                    "namespace.anyimplwithouthandler"
                ),
    ...
    public void shouldHaveRequiredGroupsSetForAuditProducer() {
        //when
        BindingProperties auditProducer = bindingServiceProperties.getBindingProperties(
            "auditProducer"
        );
    ...
    public void shouldHaveChannelBindingsSetForCommandEndpoint() {
        //when
        BindingProperties commandConsumer = bindingServiceProperties.getBindingProperties(
            "commandConsumer"
        );
        BindingProperties commandResults = bindingServiceProperties.getBindingProperties(
            "commandResults"
        );
    ...
    public void shouldHaveChannelBindingsSetForSignalEvents() {
        //when
        BindingProperties signalProducer = bindingServiceProperties.getBindingProperties(
            "signalProducer"
        );
        BindingProperties signalConsumer = bindingServiceProperties.getBindingProperties(
            "signalConsumer"
        );

        //then
        assertThat(signalProducer.getDestination())
            .isEqualTo("namespace.signal-event");
        assertThat(signalProducer.getProducer().getRequiredGroups())
            .containsExactly("my-activiti-rb-app");
        assertThat(signalConsumer.getDestination())
            .isEqualTo("namespace.signal-event");
    ...
    public void shouldHaveChannelBindingsSetForCloudConnectors() {
        ...
        assertThat(integrationResultsConsumer.getGroup())
        ...
        assertThat(integrationErrorsConsumer.getGroup())
            .isEqualTo("my-activiti-rb-app");
    }
    ...
    public void shouldHaveChannelBindingsSetForAsyncJobExecutor() {
        ...
        assertThat(asyncExecutorJobsInput.getGroup())
            .isEqualTo("my-activiti-rb-app");
