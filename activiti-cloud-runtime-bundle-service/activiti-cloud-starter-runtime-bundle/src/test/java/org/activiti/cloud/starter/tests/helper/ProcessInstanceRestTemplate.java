...
public class ProcessInstanceRestTemplate {
    ...
    public ResponseEntity<CloudProcessInstance> startProcess(
            String processDefinitionId, Map<String, Object> variables, String businessKey) {
    ...
    private ResponseEntity<CloudProcessInstance> startProcessWithoutCheck(
            String baseURL, StartProcessPayload startProcess) {
    ...
    private ResponseEntity<CloudProcessInstance> createProcessWithoutCheck(
            String baseURL, CreateProcessInstancePayload payload) {
        return testRestTemplate.exchange(
                baseURL,
                HttpMethod.POST,
    ...
    private ResponseEntity<CloudProcessInstance> startProcess(
            String baseURL, StartProcessPayload startProcess) {
        ResponseEntity<CloudProcessInstance> responseEntity =
                startProcessWithoutCheck(baseURL, startProcess);
    ...
    public ResponseEntity<ActivitiErrorMessageImpl> startCreatedProcessFailing(
        ...
        ResponseEntity<ActivitiErrorMessageImpl> responseEntity =
                startCreatedProcessCallFail(baseURL);
        return responseEntity;
    }

    private ResponseEntity<CloudProcessInstance> createProcess(
            String baseURL, CreateProcessInstancePayload startProcess) {
        ResponseEntity<CloudProcessInstance> responseEntity =
                createProcessWithoutCheck(baseURL, startProcess);
    ...
    public ResponseEntity<CloudProcessInstance> startProcessByKey(
            String processDefinitionKey, Map<String, Object> variables, String businessKey) {
    ...
    public ResponseEntity<PagedModel<CloudTask>> getTasks(String processInstanceId) {
        ResponseEntity<PagedModel<CloudTask>> responseEntity =
    ...
    public ResponseEntity<CollectionModel<CloudVariableInstance>> getVariables(
        ...
        ResponseEntity<CollectionModel<CloudVariableInstance>> responseEntity =
                getVariablesNoReplyCheck(processInstanceId);
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        return responseEntity;
    }
        ...
        ResponseEntity<CollectionModel<CloudVariableInstance>> responseEntity =
                testRestTemplate.exchange(
                        ...
                        new ParameterizedTypeReference<
                                CollectionModel<CloudVariableInstance>>() {});
        return responseEntity;
    }
    ...
    public ResponseEntity<CloudProcessInstance> getProcessInstance(
            String baseURL, String processInstanceId) {
    ...
    public ResponseEntity<Void> setVariablesDoNotCheckStatus(
        ...
        HttpEntity<SetProcessVariablesPayload> requestEntity =
                new HttpEntity<>(setProcessVariablesPayload, null);
        ResponseEntity<Void> responseEntity =
                testRestTemplate.exchange(
                        PROCESS_INSTANCES_RELATIVE_URL + processInstanceId + "/variables/",
                        HttpMethod.POST,
    ...
    public ResponseEntity<Void> setVariables(
        ...
        ResponseEntity<Void> responseEntity =
                setVariablesDoNotCheckStatus(processInstanceId, variables);
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        return responseEntity;
    }
    ...
    public ResponseEntity<Void> adminSetVariables(
            String processInstanceId, Map<String, Object> variables) {
        ResponseEntity<Void> responseEntity =
                adminSetVariablesDoNotCheckStatus(processInstanceId, variables);
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    public ResponseEntity<Void> adminRemoveVariables(String processId, List<String> variableNames) {
        RemoveProcessVariablesPayload removeProcessVariablesPayload =
                ProcessPayloadBuilder.removeVariables().withVariableNames(variableNames).build();

        HttpEntity<RemoveProcessVariablesPayload> requestEntity =
                new HttpEntity<>(removeProcessVariablesPayload, null);
        ResponseEntity<Void> responseEntity =
                testRestTemplate.exchange(
    ...
    public ResponseEntity<CloudProcessInstance> update(
            ResponseEntity<CloudProcessInstance> processEntity, String businessKey, String name) {
    ...
    public ResponseEntity<PagedModel<ProcessInstance>> getSubprocesses(String processInstanceId) {
        ResponseEntity<PagedModel<ProcessInstance>> responseEntity =
                testRestTemplate.exchange(
        ...
        return testRestTemplate.execute(
                ...
                new ResponseExtractor<String>() {
                    ...
                    public String extractData(ClientHttpResponse response) throws IOException {
                        return new String(
                                IoUtil.readInputStream(response.getBody(), null), "UTF-8");
                    }
                });
    }
    ...
    public ResponseEntity<PagedModel<ProcessInstance>> getPagedProcessInstances(
            String baseURL, String pageFilters) {
