...
public class ProcessInstanceRestTemplate {
    ...
    public static final String PROCESS_INSTANCES_RELATIVE_URL =
        "/v1/process-instances/";

    public static final String PROCESS_INSTANCES_ADMIN_RELATIVE_URL =
    ...
    private ResponseEntity<CloudProcessInstance> startProcess(
    ...
    private ResponseEntity<CloudProcessInstance> createProcess(
        String processDefinitionKey,
        String processDefinitionId,
        Map<String, Object> variables,
        String businessKey
    ...
    public ResponseEntity<CloudProcessInstance> startProcess(
        String processDefinitionId
    ) {
        return startProcess(processDefinitionId, null, null);
    }
    ...
    public ResponseEntity<CloudProcessInstance> startProcess(
        ...
        return startProcess(processDefinitionId, variables, null);
    }
    ...
    public ResponseEntity<CloudProcessInstance> startProcess(
        ...
        return startProcess(null, processDefinitionId, variables, businessKey);
    }

    public ResponseEntity<CloudProcessInstance> createProcess(
        String processDefinitionId,
        Map<String, Object> variables,
        String businessKey
    ) {
        return createProcess(null, processDefinitionId, variables, businessKey);
    }
    ...
    public ResponseEntity<CloudProcessInstance> createProcess(
        CreateProcessInstancePayload startPayload
    ) {
        return createProcess(
            PROCESS_INSTANCES_RELATIVE_URL + "create",
            startPayload
        );
    }

    public ResponseEntity<CloudProcessInstance> adminStartProcess(
        StartProcessPayload startProcess
    ) {
        return startProcess(PROCESS_INSTANCES_ADMIN_RELATIVE_URL, startProcess);
    }

    private ResponseEntity<CloudProcessInstance> startProcessWithoutCheck(
        String baseURL,
        StartProcessPayload startProcess
    ) {
    ...
    private ResponseEntity<CloudProcessInstance> startCreatedProcessCall(
        String baseURL
    ) {
        return testRestTemplate.exchange(
            baseURL,
    ...
    private ResponseEntity<ActivitiErrorMessageImpl> startCreatedProcessCallFail(
        String baseURL
    ) {
        return testRestTemplate.exchange(
            baseURL,
    ...
    private ResponseEntity<CloudProcessInstance> createProcessWithoutCheck(
        String baseURL,
        CreateProcessInstancePayload payload
    ) {
        return testRestTemplate.exchange(
            baseURL,
            HttpMethod.POST,
    ...
    private ResponseEntity<CloudProcessInstance> startProcess(
        ...
        ResponseEntity<CloudProcessInstance> responseEntity = startProcessWithoutCheck(
            baseURL,
            startProcess
        );
    ...
    public ResponseEntity<CloudProcessInstance> startCreatedProcess(
        String processInstanceId
    ) {
        String baseURL = PROCESS_INSTANCES_RELATIVE_URL
            .concat(processInstanceId)
            .concat("/start");
        ResponseEntity<CloudProcessInstance> responseEntity = startCreatedProcessCall(
            baseURL
        );
    ...
    public ResponseEntity<ActivitiErrorMessageImpl> startCreatedProcessFailing(
        String processInstanceId
    ) {
        String baseURL = PROCESS_INSTANCES_RELATIVE_URL
            .concat(processInstanceId)
            .concat("/start");
        ResponseEntity<ActivitiErrorMessageImpl> responseEntity = startCreatedProcessCallFail(
            baseURL
        );
        return responseEntity;
    }
    ...
    private ResponseEntity<CloudProcessInstance> createProcess(
        String baseURL,
        CreateProcessInstancePayload startProcess
    ) {
        ResponseEntity<CloudProcessInstance> responseEntity = createProcessWithoutCheck(
            baseURL,
            startProcess
        );
    ...
    public ResponseEntity<CloudProcessInstance> startProcessByKey(
        String processDefinitionKey,
        Map<String, Object> variables,
        String businessKey
    ) {
    ...
    public ResponseEntity<ActivitiErrorMessageImpl> startProcessWithErrorResponse(
        ...
        return startProcessWithErrorResponse(
            PROCESS_INSTANCES_RELATIVE_URL,
            startProcess
        );
    }
    ...
    public ResponseEntity<CollectionModel<CloudVariableInstance>> getVariables(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
    ...
    public ResponseEntity<CollectionModel<CloudVariableInstance>> getVariables(
        ...
        ResponseEntity<CollectionModel<CloudVariableInstance>> responseEntity = getVariablesNoReplyCheck(
            processInstanceId
        );
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
        return responseEntity;
    ...
    public ResponseEntity<CollectionModel<CloudVariableInstance>> getVariablesNoReplyCheck(
        String processInstanceId
    ) {
    ...
    public ResponseEntity<ActivitiErrorMessageImpl> callGetVariablesWithErrorResponse(
        String processInstanceId
    ) {
    ...
    public ResponseEntity<CloudProcessInstance> getProcessInstance(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
    ...
    public ResponseEntity<CloudProcessInstance> adminGetProcessInstance(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
    ...
    public ResponseEntity<CloudProcessInstance> delete(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
        ResponseEntity<CloudProcessInstance> responseEntity = testRestTemplate.exchange(
            PROCESS_INSTANCES_RELATIVE_URL +
            processInstanceEntity.getBody().getId(),
            HttpMethod.DELETE,
            null,
            new ParameterizedTypeReference<CloudProcessInstance>() {}
        );
    ...
    public ResponseEntity<CloudProcessInstance> adminDelete(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
        ResponseEntity<CloudProcessInstance> responseEntity = testRestTemplate.exchange(
    ...
    public ResponseEntity<Void> adminSuspend(
        ResponseEntity<CloudProcessInstance> processInstanceEntity
    ) {
        assertThat(processInstanceEntity.getBody()).isNotNull();
        return suspend(
    ...
    private ResponseEntity<Void> suspend(
        String baseURL,
        String processInstanceId
    ) {
    ...
    public ResponseEntity<Void> adminResume(
        ResponseEntity<CloudProcessInstance> startProcessEntity
    ) {
        assertThat(startProcessEntity.getBody()).isNotNull();
        return resume(
    ...
    private ResponseEntity<Void> resume(
        String baseURL,
        String processInstanceId
    ) {
        ResponseEntity<Void> responseEntity = testRestTemplate.exchange(
    ...
    public ResponseEntity<Void> setVariablesDoNotCheckStatus(
        String processInstanceId,
        Map<String, Object> variables
    ) {
    ...
    public ResponseEntity<Void> setVariables(
        ...
        ResponseEntity<Void> responseEntity = setVariablesDoNotCheckStatus(
            processInstanceId,
            variables
        );
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    public ResponseEntity<Void> adminSetVariablesDoNotCheckStatus(
        String processInstanceId,
        Map<String, Object> variables
    ) {
        SetProcessVariablesPayload setProcessVariablesPayload = ProcessPayloadBuilder
    ...
    public ResponseEntity<Void> adminSetVariables(
        String processInstanceId,
        Map<String, Object> variables
    ) {
        ResponseEntity<Void> responseEntity = adminSetVariablesDoNotCheckStatus(
            processInstanceId,
            variables
        );
        assertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    public ResponseEntity<Void> adminRemoveVariables(
        String processId,
    ...
    public ResponseEntity<CloudProcessInstance> update(
        ResponseEntity<CloudProcessInstance> processEntity,
        String businessKey,
        String name
    ) {
    ...
    private ResponseEntity<CloudProcessInstance> updateProcess(
        UpdateProcessPayload updateProcessPayload
    ) {
        HttpEntity<UpdateProcessPayload> requestEntity = new HttpEntity<>(
    ...
    public ResponseEntity<CloudProcessInstance> adminUpdate(
        ResponseEntity<CloudProcessInstance> processEntity,
        String businessKey,
        String name
    ) {
    ...
    private ResponseEntity<CloudProcessInstance> adminUpdateProcess(
        UpdateProcessPayload updateProcessPayload
    ) {
        HttpEntity<UpdateProcessPayload> requestEntity = new HttpEntity<>(
            updateProcessPayload
    ...
    public ResponseEntity<PagedModel<ProcessInstance>> getSubprocesses(
        String processInstanceId
    ) {
        ...
        return testRestTemplate.execute(
            ...
            new ResponseExtractor<String>() {
                ...
                public String extractData(ClientHttpResponse response)
                    throws IOException {
                    return new String(
                        IoUtil.readInputStream(response.getBody(), null),
                        "UTF-8"
                    );
                }
            }
    ...
    public ResponseEntity<PagedModel<ProcessInstance>> adminGetPagedProcessInstances(
        ...
        return getPagedProcessInstances(
            PROCESS_INSTANCES_ADMIN_RELATIVE_URL,
            pages
        );
    }
