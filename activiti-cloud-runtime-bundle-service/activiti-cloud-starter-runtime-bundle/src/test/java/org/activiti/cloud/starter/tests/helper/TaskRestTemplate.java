...
public class TaskRestTemplate {
    ...
    public ResponseEntity<CloudTask> complete(
        Task task,
    ...
    private ResponseEntity<CloudTask> delete(
        Task task,
    ...
    public ResponseEntity<CloudTask> adminAssignTask(
        AssignTaskPayload assignTask
    ) {
    ...
    public ResponseEntity<Void> addUserCandidates(
    ...
    public ResponseEntity<Void> deleteUserCandidates(
        CandidateUsersPayload candidateUsers
    ) {
        ResponseEntity<Void> responseEntity = testRestTemplate.exchange(
            TASK_RELATIVE_URL + candidateUsers.getTaskId() + "/candidate-users",
    ...
    public ResponseEntity<Void> addGroupCandidates(
        CandidateGroupsPayload candidateGroups
    ) {
        ResponseEntity<Void> responseEntity = testRestTemplate.exchange(
            TASK_RELATIVE_URL +
            candidateGroups.getTaskId() +
            "/candidate-groups",
            HttpMethod.POST,
    ...
    public ResponseEntity<Void> deleteGroupCandidates(
        CandidateGroupsPayload candidateGroups
    ) {
        ResponseEntity<Void> responseEntity = testRestTemplate.exchange(
            TASK_RELATIVE_URL +
    ...
    public ResponseEntity<Void> updateVariable(
        ...
        ResponseEntity<Void> responseEntity = testRestTemplate.exchange(
            TaskRestTemplate.TASK_RELATIVE_URL +
            taskId +
    ...
    public ResponseEntity<Void> adminCreateVariable(
        String taskId,
        String name,
        Object value
    ) {
    ...
    public ResponseEntity<Void> adminUpdateVariable(
        String taskId,
        String name,
        Object value
    ) {
    ...
    public ResponseEntity<CloudTask> userAssignTask(
        AssignTaskPayload assignTask
    ) {
        ResponseEntity<CloudTask> responseEntity = testRestTemplate.exchange(
