...
public class SignalIT {
    ...
    public void shouldBroadcastSignalsWithProcessInstanceRest() {
        ...
        SignalPayload signalProcessInstancesCmd =
                ProcessPayloadBuilder.signal().withName("Test").build();
    ...
    public void shouldBroadcastSignalsWithVariables() {
        // when
        org.activiti.engine.runtime.ProcessInstance procInst1 =
                runtimeService.startProcessInstanceByKey("broadcastSignalCatchEventProcess2");
        runtimeService.startProcessInstanceByKey(
                "broadcastSignalEventProcess", Collections.singletonMap("myVar", "myContent"));
        ...
        // then
        assertThat(runtimeService.getVariables(procInst1.getId()).get("myVar"))
                .isEqualTo("myContent");
    }
    ...
    public void shouldBroadcastDifferentSignals() {
        ...
        org.activiti.engine.runtime.ProcessInstance procInst1 =
                runtimeService.startProcessInstanceByKey("broadcastSignalCatchEventProcess");
        org.activiti.engine.runtime.ProcessInstance procInst2 =
                runtimeService.startProcessInstanceByKey("broadcastSignalEventProcess");
        ...
        // then
        List<org.activiti.engine.runtime.ProcessInstance> processInstances1 =
                runtimeService
                        .createProcessInstanceQuery()
                        .processInstanceId(procInst1.getId())
                        .list();
        ...
        org.activiti.engine.runtime.ProcessInstance procInst3 =
                runtimeService.startProcessInstanceByKey(SIGNAL_PROCESS);
        org.activiti.engine.runtime.ProcessInstance procInst4 =
                runtimeService.startProcessInstanceByKey("signalThrowEventProcess");
    ...
    public void processShouldTakeExceptionPathWhenSignalIsSent() {
        ...
        SignalPayload signalProcessInstancesCmd =
                ProcessPayloadBuilder.signal().withName("go").build();
    ...
    private ResponseEntity<PagedModel<CloudProcessDefinition>> getProcessDefinitions() {
        ...
        return restTemplate.exchange(
                ProcessDefinitionIT.PROCESS_DEFINITIONS_URL, HttpMethod.GET, null, responseType);
    }
}
