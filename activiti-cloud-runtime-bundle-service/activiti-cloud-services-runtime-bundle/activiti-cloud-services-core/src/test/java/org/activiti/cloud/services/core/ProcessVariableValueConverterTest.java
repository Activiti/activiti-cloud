...
@SpringBootTest(
    ...
    classes = TestProcessEngineConfiguration.class
)
...
public class ProcessVariableValueConverterTest {
    ...
    public void testProcessVariableValueConverterNullValue() {
        // when
        String nullValue = variableValueConverter.convert(
            new ProcessVariableValue("String", null)
        );
    ...
    public void testProcessVariableValueConverterStringValue() {
        // when
        String stringValue = variableValueConverter.convert(
            new ProcessVariableValue("string", "name")
        );
    ...
    public void testProcessVariableValueConverterIntValue() {
        // when
        Integer intValue = variableValueConverter.convert(
            new ProcessVariableValue("int", "10")
        );
    ...
    public void testProcessVariableValueConverterLongValue() {
        // when
        Long longValue = variableValueConverter.convert(
            new ProcessVariableValue("long", "10")
        );
    ...
    public void testProcessVariableValueConverterBooleanValue() {
        // when
        Boolean booleanValue = variableValueConverter.convert(
            new ProcessVariableValue("boolean", "true")
        );
    ...
    public void testProcessVariableValueConverterDoubleValue() {
        // when
        Double doubleValue = variableValueConverter.convert(
            new ProcessVariableValue("double", "10.00")
        );
    ...
    public void testProcessVariableValueConverterLocalDateValue() {
        // when
        LocalDate localDateValue = variableValueConverter.convert(
    ...
    public void testProcessVariableValueConverterBigDecimalValue() {
        // when
        BigDecimal bigDecimalValue = variableValueConverter.convert(
    ...
    public void testProcessVariableValueConverterJsonNodeValue() {
        // when
        JsonNode jsonNodeValue = variableValueConverter.convert(
            new ProcessVariableValue("json", "{}")
        );

        // then
        assertThat(jsonNodeValue)
