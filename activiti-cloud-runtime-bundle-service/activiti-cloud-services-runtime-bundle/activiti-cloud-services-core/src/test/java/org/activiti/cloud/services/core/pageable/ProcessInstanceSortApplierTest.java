...
public class ProcessInstanceSortApplierTest {
    ...
    @Test
    public void applySort_should_oder_by_process_instance_id_asc_by_default()
        throws Exception {
        //given
        ProcessInstanceQuery query = MockUtils.selfReturningMock(
    ...
    public void applySort_should_use_the_criteria_defined_by_pageable_object()
        ...
        inOrder
            .verify(query)
            .orderBy(ProcessInstanceQueryProperty.PROCESS_DEFINITION_ID);
