...
public class ProcessVariablesPayloadConverterTest {
    ...
    @Autowired private ProcessVariablesPayloadConverter subject;
    ...
    public void testProcessVariablesPayloadConverter() {
        ...
        // when
        StartProcessPayload result =
                subject.convert(ProcessPayloadBuilder.start().withVariables(input).build());
        // then
        assertThat(result.getVariables())
                ...
                .containsEntry(
                        "dateValue", dateFormatterProvider.parse(DATE_1970_01_01T01_01_01_001Z))
