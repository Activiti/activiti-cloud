...
public class BasicAuthenticationProviderTest {
    ...
    @InjectMocks private BasicAuthenticationProvider basicAuthenticationProvider;
    ...
    public void testAuthenticate() {
        ...
        UsernamePasswordAuthenticationToken authentication =
                new UsernamePasswordAuthenticationToken("test", "pass", authorities);
    ...
    public void testAuthenticationFailure() {
        ...
        UsernamePasswordAuthenticationToken authentication =
                new UsernamePasswordAuthenticationToken(
                        "differentuser", "differentpass", authorities);
    ...
    public void testSupports() {
        assertThat(basicAuthenticationProvider.supports(UsernamePasswordAuthenticationToken.class))
                .isTrue();
