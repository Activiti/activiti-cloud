...
public class ConnectorDefinitionControllerImplIT {
    ...
    @SpyBean private CollectionModelAssembler representationModelAssembler;
    ...
    public void getOneSpecificConnectorDefinition() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(
                        jsonPath("links[0].href", containsString("v1/connector-definitions/id1")))
    ...
    public void getConnectorDefinitionNotFound() throws Exception {
        ...
        this.mockMvc
                .perform(
                        get("/v1/connector-definitions/idNotFound")
