...
public class TaskAdminControllerImplIT {
    ...
    public void getTasks() throws Exception {
        ...
        this.mockMvc.perform(
                get("/admin/v1/tasks?page=0&size=10")
    ...
    public void getTasksShouldUseAlfrescoGuidelineWhenMediaTypeIsApplicationJson()
        ...
        this.mockMvc.perform(
                get("/admin/v1/tasks?skipCount=10&maxItems=10")
    ...
    public void deleteTask() throws Exception {
        given(taskAdminRuntime.delete(any()))
            .willReturn(buildDefaultAssignedTask());
        this.mockMvc.perform(delete("/admin/v1/tasks/{taskId}", 1))
            .andExpect(status().isOk());
    }

    @Test
    public void updateTask() throws Exception {
        given(taskAdminRuntime.update(any()))
            .willReturn(buildDefaultAssignedTask());
    ...
    public void completeTask() throws Exception {
        given(taskAdminRuntime.complete(any()))
            .willReturn(buildDefaultAssignedTask());
        this.mockMvc.perform(post("/admin/v1/tasks/{taskId}/complete", 1))
            .andExpect(status().isOk());
    }

    @Test
    public void assignTask() throws Exception {
        given(taskAdminRuntime.assign(any()))
            .willReturn(buildDefaultAssignedTask());
