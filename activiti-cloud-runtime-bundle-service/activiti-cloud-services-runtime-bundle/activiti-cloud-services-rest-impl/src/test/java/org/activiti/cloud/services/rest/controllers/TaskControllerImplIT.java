...
public class TaskControllerImplIT {
    ...
    @SpyBean private SpringPageConverter springPageConverter;

    @MockBean private ProcessEngineChannels processEngineChannels;

    @Mock private Page<Task> taskPage;
    ...
    public void getTasks() throws Exception {
        ...
        this.mockMvc
                .perform(get("/v1/tasks?page=10&size=10").accept(MediaTypes.HAL_JSON_VALUE))
    ...
    public void saveTask() throws Exception {
        SaveTaskPayload saveTask =
                TaskPayloadBuilder.save().withTaskId("1").withVariable("name", "value").build();
    ...
    public void getTaskByIdTaskNotFound() throws Exception {
        ...
        this.mockMvc
                .perform(get("/v1/tasks/{taskId}", "not-existent-task"))
    ...
    public void updateTask() throws Exception {
        ...
        UpdateTaskPayload updateTaskCmd =
    ...
    public void assignTask() throws Exception {
        ...
        AssignTaskPayload assignTaskCmd =
                TaskPayloadBuilder.assign().withTaskId("1").withAssignee("assignee").build();
