...
public class ProcessDefinitionControllerImplIT {
    ...
    public void getProcessDefinitions() throws Exception {
        ...
        List<ProcessDefinition> processDefinitionList =
                Collections.singletonList(
                        buildProcessDefinition(procId, my_process, this_is_my_process, version));
    ...
    private ProcessDefinition buildProcessDefinition(
            String processDefinitionId, String name, String description, int version) {
    ...
    public void getProcessDefinitionsShouldUseAlfrescoGuidelineWhenMediaTypeIsApplicationJson()
        ...
        ProcessDefinition processDefinition =
                buildProcessDefinition(processDefId, "my process", "This is my process", 1);
        List<ProcessDefinition> processDefinitionList =
