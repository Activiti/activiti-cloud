...
public class ProcessDefinitionControllerImplIT {
    ...
    public void getProcessDefinitions() throws Exception {
        ...
        mockMvc
            .perform(
                get("/v1/process-definitions").accept(MediaTypes.HAL_JSON_VALUE)
            )
    ...
    public void getProcessDefinitionsShouldUseAlfrescoGuidelineWhenMediaTypeIsApplicationJson()
        ...
        given(processRuntime.processDefinitions(any()))
    ...
    public void shouldGetProcessDefinitionById() throws Exception {
        ...
        mockMvc
            .perform(
                get("/v1/process-definitions/{id}", processId)
    ...
    @Test
    public void getProcessDefinitionShouldUseAlfrescoGuidelineWhenMediaTypeIsApplicationJson()
        throws Exception {
        ...
        MvcResult result = mockMvc
            .perform(
                get("/v1/process-definitions/{id}", procDefId)
                    .accept(MediaType.APPLICATION_JSON_VALUE)
            )
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void shouldGetXMLProcessModel() throws Exception {
        ...
        when(repositoryService.getProcessModel(processDefinitionId))
            .thenReturn(xml);

        mockMvc
            .perform(
                get("/v1/process-definitions/{id}/model", processDefinitionId)
    ...
    public void shouldGetBpmnJsonModel() throws Exception {
        ...
        when(repositoryService.getBpmnModel(processDefinitionId))
    ...
    @Test
    public void should_getProcessDiagramReturnNotFound_when_processDefinitionIsNotFound()
        throws Exception {
    ...
    @Test
    public void should_getProcessDiagramReturnNoContent_when_noInterchangeInfo()
        throws Exception {
        String processDefinitionId = UUID.randomUUID().toString();
        BpmnModel bpmnModel = new BpmnModel();
