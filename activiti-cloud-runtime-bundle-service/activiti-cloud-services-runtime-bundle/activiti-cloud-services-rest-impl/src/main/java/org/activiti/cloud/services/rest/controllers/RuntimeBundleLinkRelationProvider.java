...
public class RuntimeBundleLinkRelationProvider implements LinkRelationProvider {
    ...
    public RuntimeBundleLinkRelationProvider() {
        ...
        resourceRelationDescriptors.put(
            ...
            new ResourceRelationDescriptor(
                "processDefinition",
                "processDefinitions"
            )
        );
        ...
        resourceRelationDescriptors.put(
            CloudTaskImpl.class,
            new ResourceRelationDescriptor("task", "tasks")
        );
    ...
    public LinkRelation getCollectionResourceRelFor(Class<?> aClass) {
        return resourceRelationDescriptors
            .get(aClass)
            .getCollectionResourceRel();
    }
    ...
    class ResourceRelationDescriptor {
        ...
        public ResourceRelationDescriptor(
