...
public class ProcessDefinitionAdminControllerImpl implements ProcessDefinitionAdminController {
    ...
    public PagedModel<EntityModel<CloudProcessDefinition>> getAllProcessDefinitions(
        ...
        Page<ProcessDefinition> page =
                processAdminRuntime.processDefinitions(pageConverter.toAPIPageable(pageable));
        return pagedCollectionModelAssembler.toModel(
                pageable, pageConverter.toSpringPage(pageable, page), representationModelAssembler);
    }
}
