...
public class ProcessInstanceRepresentationModelAssembler
    implements
        RepresentationModelAssembler<ProcessInstance, EntityModel<CloudProcessInstance>> {
    ...
    public EntityModel<CloudProcessInstance> toModel(
        ...
        CloudProcessInstance cloudProcessInstance = toCloudProcessInstanceConverter.from(
            processInstance
        );
