...
public class CandidateUserControllerImpl implements CandidateUserController {
    ...
    private final UserCandidatesRepresentationModelAssembler
    ...
    public CandidateUserControllerImpl(
        ...
        this.userCandidatesRepresentationModelAssembler =
                userCandidatesRepresentationModelAssembler;
    ...
    public void addCandidateUsers(
            @PathVariable String taskId, @RequestBody CandidateUsersPayload candidateUsersPayload) {
    ...
    @Override
    public CollectionModel<EntityModel<CandidateUser>> getUserCandidates(
