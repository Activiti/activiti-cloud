...
public class CandidateGroupAdminControllerImpl implements CandidateGroupAdminController {
    ...
    public CandidateGroupAdminControllerImpl(
        ...
        this.groupCandidatesRepresentationModelAssembler =
                groupCandidatesRepresentationModelAssembler;
    ...
    @Override
    public CollectionModel<EntityModel<CandidateGroup>> getGroupCandidates(
            @PathVariable String taskId) {
        groupCandidatesRepresentationModelAssembler.setTaskId(taskId);
        return resourcesAssembler.toCollectionModel(
                toCandidateGroupConverter.from(taskAdminRuntime.groupCandidates(taskId)),
                groupCandidatesRepresentationModelAssembler,
                linkTo(
