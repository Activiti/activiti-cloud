...
public class ServicesRestWebMvcAutoConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    public ConnectorDefinitionRepresentationModelAssembler
            connectorDefinitionRepresentationModelAssembler() {
        return new ConnectorDefinitionRepresentationModelAssembler();
    }

    @Bean
    public ProcessDefinitionMetaRepresentationModelAssembler
    ...
    public TaskRepresentationModelAssembler taskRepresentationModelAssembler(
        ...
        return new TaskRepresentationModelAssembler(
                new ToCloudTaskConverter(runtimeBundleInfoAppender));
    }
    ...
    @Bean
    public GroupCandidatesRepresentationModelAssembler
    ...
    public void extendMessageConverters(List<HttpMessageConverter<?>> converters) {
        // for some, not yet identified, reason the ObjectMapper used by
