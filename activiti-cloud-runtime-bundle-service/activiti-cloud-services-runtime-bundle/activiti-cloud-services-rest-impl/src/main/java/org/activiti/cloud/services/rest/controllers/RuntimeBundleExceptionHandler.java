...
public class RuntimeBundleExceptionHandler {
    ...
    public EntityModel<ActivitiErrorMessage> handleAppException(
        ...
        return EntityModel.of(
            new ActivitiErrorMessageImpl(NOT_FOUND.value(), ex.getMessage())
        );
    }
    ...
    public EntityModel<ActivitiErrorMessage> handleAppException(
        ...
        response.setContentType(APPLICATION_JSON_VALUE);
        return EntityModel.of(
            new ActivitiErrorMessageImpl(FORBIDDEN.value(), ex.getMessage())
        );
    }
    ...
    @ExceptionHandler(
        { NotFoundException.class, ActivitiObjectNotFoundException.class }
    )
    ...
    public EntityModel<ActivitiErrorMessage> handleAppException(
        ...
        response.setContentType(APPLICATION_JSON_VALUE);
        return EntityModel.of(
            new ActivitiErrorMessageImpl(BAD_REQUEST.value(), ex.getMessage())
        );
    }
