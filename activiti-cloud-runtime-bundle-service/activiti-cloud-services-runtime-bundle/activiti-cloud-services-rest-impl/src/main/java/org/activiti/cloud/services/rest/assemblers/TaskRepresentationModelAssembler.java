    ...
    public EntityModel<CloudTask> toModel(Task task) {
        ...
        if (ASSIGNED != cloudTask.getStatus()) {
            ...
            links.add(
                linkTo(
                    methodOn(TaskControllerImpl.class)
                        .completeTask(cloudTask.getId(), null)
                )
                    .withRel("complete")
            );
        }
        ...
        if (
            cloudTask.getProcessInstanceId() != null &&
        ...
        if (
            cloudTask.getParentTaskId() != null &&
            !cloudTask.getParentTaskId().isEmpty()
        ) {
            links.add(
                linkTo(
                    methodOn(TaskControllerImpl.class)
