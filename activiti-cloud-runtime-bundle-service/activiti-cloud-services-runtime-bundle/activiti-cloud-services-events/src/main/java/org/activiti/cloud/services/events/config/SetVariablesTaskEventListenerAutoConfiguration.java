...
@AutoConfiguration
public class SetVariablesTaskEventListenerAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public ProcessEngineEventListenerRegistration setVariablesTaskErrorListenerRegistration(
    ...
    public static class ProcessEngineEventListenerRegistration {
        ...
        public ProcessEngineEventListenerRegistration(
            RuntimeService runtimeService,
            SetVariablesTaskErrorProducer setVariablesTaskErrorProducer
        ) {
            // Register the SetVariablesTaskErrorProducer to listen for all events
            runtimeService.addEventListener(setVariablesTaskErrorProducer);
        }
    }
}
