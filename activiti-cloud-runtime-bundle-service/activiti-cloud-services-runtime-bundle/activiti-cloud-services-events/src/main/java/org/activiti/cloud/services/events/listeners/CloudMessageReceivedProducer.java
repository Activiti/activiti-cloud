...
public class CloudMessageReceivedProducer implements BPMNElementEventListener<BPMNMessageReceivedEvent> {
    ...
    public CloudMessageReceivedProducer(ToCloudProcessRuntimeEventConverter eventConverter,
