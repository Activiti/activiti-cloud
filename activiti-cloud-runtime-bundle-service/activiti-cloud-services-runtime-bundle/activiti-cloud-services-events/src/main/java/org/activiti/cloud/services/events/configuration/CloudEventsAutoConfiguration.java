...
@PropertySources(
    value = {
        @PropertySource(
            value = "classpath:/META-INF/activiti-audit-producer.properties"
        ), // default
        @PropertySource(
            value = "classpath:/activiti-audit-producer.properties",
...
public class CloudEventsAutoConfiguration {
    ...
    public ToCloudProcessRuntimeEventConverter toCloudProcessRuntimeEventConverter(
        ...
        return new ToCloudProcessRuntimeEventConverter(
    ...
    public CloudTaskCreatedProducer cloudTaskCreatedProducer(
        ...
        return new CloudTaskCreatedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskUpdatedProducer cloudTaskUpdatedProducer(
        ...
        return new CloudTaskUpdatedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCancelledProducer cloudTaskCancelledProducer(
        ...
        return new CloudTaskCancelledProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskAssignedProducer cloudTaskAssignedProducer(
        ...
        return new CloudTaskAssignedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskSuspendedProducer cloudTaskSuspendedProducer(
        ...
        return new CloudTaskSuspendedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskActivatedProducer cloutTaskActivatedProducer(
        ...
        return new CloudTaskActivatedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCompletedProducer cloudTaskCompletedProducer(
        ...
        return new CloudTaskCompletedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCandidateUserAddedProducer cloudTaskCandidateUserAddedProducer(
        ...
        return new CloudTaskCandidateUserAddedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCandidateUserRemovedProducer taskCandidateUserRemovedProducer(
        ...
        return new CloudTaskCandidateUserRemovedProducer(
            converter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCandidateGroupAddedProducer cloudTaskCandidateGroupAddedProducer(
        ...
        return new CloudTaskCandidateGroupAddedProducer(
            taskRuntimeEventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTaskCandidateGroupRemovedProducer cloudTaskCandidateGroupRemovedProducer(
        ...
        return new CloudTaskCandidateGroupRemovedProducer(
            converter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessCreatedProducer processCreatedProducer(
        ...
        return new CloudProcessCreatedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessStartedProducer processStartedProducer(
        ...
        return new CloudProcessStartedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessSuspendedProducer cloudProcessSuspendedProducer(
        ...
        return new CloudProcessSuspendedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessResumedProducer cloudProcessResumedProducer(
        ...
        return new CloudProcessResumedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessCompletedProducer cloudProcessCompletedProducer(
        ...
        return new CloudProcessCompletedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessCancelledProducer cloudProcessCancelledProducer(
        ...
        return new CloudProcessCancelledProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudProcessUpdatedProducer cloudProcessUpdatedProducer(
        ...
        return new CloudProcessUpdatedProducer(
            eventConverter,
            eventsAggregator
        );
    }
    ...
    public CloudTimerRetriesDecrementedProducer cloudTimerRetriesDecrementedProducer(
        ...
        return new CloudTimerRetriesDecrementedProducer(
            converter,
            eventsAggregator
        );
    }
    ...
    @Bean
    @ConditionalOnMissingBean
    public RuntimeBundleMessageBuilderFactory runtimeBundleMessageBuilderFactory(
        RuntimeBundleProperties properties
    ) {
    ...
    public CloudMessageSubscriptionCancelledProducer cloudMessageSubscriptionCancelledProducer(
        ...
        return new CloudMessageSubscriptionCancelledProducer(
            converter,
            eventsAggregator
        );
    }
