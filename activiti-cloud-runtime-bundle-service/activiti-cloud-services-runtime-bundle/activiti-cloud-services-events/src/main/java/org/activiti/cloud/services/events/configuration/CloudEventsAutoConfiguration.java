...
@PropertySources(
        value = {
            @PropertySource(
                    value = "classpath:/META-INF/activiti-audit-producer.properties"), // default
            @PropertySource(
                    value = "classpath:/activiti-audit-producer.properties",
                    ignoreResourceNotFound = true) // optional override
        })
public class CloudEventsAutoConfiguration {
    ...
    public CloudTaskCandidateGroupAddedProducer cloudTaskCandidateGroupAddedProducer(
        ...
        return new CloudTaskCandidateGroupAddedProducer(
                taskRuntimeEventConverter, eventsAggregator);
    }
