...
public class CloudEventsAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public MessageProducerCommandContextCloseListener apiMessageProducerCommandContextCloseListener(StreamBridge streamBridge,
            ExecutionContextMessageBuilderFactory executionContextMessageBuilderFactory,
            RuntimeBundleInfoAppender runtimeBundleInfoAppender) {
        return new MessageProducerCommandContextCloseListener(streamBridge,
