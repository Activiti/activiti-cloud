 ...
 */
package org.activiti.cloud.services.events.support;
...
public class MessageSenderTransactionSynchronization implements TransactionSynchronization {
    ...
    public void afterCommit() {
        logger.debug("Sending message '{}' via message channel: {}", message, messageChannel);
        ...
        try {
            ...
            logger.error("Sending message {} failed due to error: {}", message, cause.getMessage());
        }
    }
}
