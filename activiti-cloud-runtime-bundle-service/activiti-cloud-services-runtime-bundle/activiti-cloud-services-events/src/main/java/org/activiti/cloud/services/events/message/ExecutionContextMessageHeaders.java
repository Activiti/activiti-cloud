...
public class ExecutionContextMessageHeaders {
    ...
    public static final String ROOT_PROCESS_DEFINITION_ID =
        "rootProcessDefinitionId";
    public static final String ROOT_PROCESS_DEFINITION_KEY =
        "rootProcessDefinitionKey";
    public static final String ROOT_PROCESS_DEFINITION_VERSION =
        "rootProcessDefinitionVersion";
    public static final String ROOT_PROCESS_DEFINITION_NAME =
