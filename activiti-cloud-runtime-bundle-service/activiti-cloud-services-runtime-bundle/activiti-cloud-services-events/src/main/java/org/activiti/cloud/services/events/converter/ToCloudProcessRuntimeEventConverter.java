...
public class ToCloudProcessRuntimeEventConverter {
    ...
    public CloudProcessCreatedEvent from(ProcessCreatedEvent event) {
        CloudProcessCreatedEventImpl cloudEvent =
                new CloudProcessCreatedEventImpl(event.getEntity());
    ...
    public CloudProcessUpdatedEvent from(ProcessUpdatedEvent event) {
        CloudProcessUpdatedEventImpl cloudEvent =
                new CloudProcessUpdatedEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudProcessResumedEvent from(ProcessResumedEvent event) {
        CloudProcessResumedEventImpl cloudEvent =
                new CloudProcessResumedEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudProcessSuspendedEvent from(ProcessSuspendedEvent event) {
        CloudProcessSuspendedEventImpl cloudEvent =
                new CloudProcessSuspendedEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudProcessCompletedEvent from(ProcessCompletedEvent event) {
        CloudProcessCompletedEventImpl cloudEvent =
                new CloudProcessCompletedEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }
    ...
    public CloudProcessCancelledEvent from(ProcessCancelledEvent event) {
        CloudProcessCancelledEventImpl cloudEvent =
                new CloudProcessCancelledEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudBPMNActivityStartedEvent from(BPMNActivityStartedEvent event) {
        CloudBPMNActivityStartedEventImpl cloudEvent =
    ...
    public CloudBPMNActivityCompletedEvent from(BPMNActivityCompletedEvent event) {
        CloudBPMNActivityCompletedEventImpl cloudEvent =
    ...
    public CloudBPMNActivityCancelledEvent from(BPMNActivityCancelledEvent event) {
        CloudBPMNActivityCancelledEventImpl cloudEvent =
    ...
    public CloudBPMNSignalReceivedEvent from(BPMNSignalReceivedEvent event) {
        CloudBPMNSignalReceivedEventImpl cloudEvent =
    ...
    public CloudSequenceFlowTakenEvent from(BPMNSequenceFlowTakenEvent event) {
        CloudSequenceFlowTakenEventImpl cloudEvent =
                new CloudSequenceFlowTakenEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudProcessDeployedEvent from(ProcessDeployedEvent event) {
        CloudProcessDeployedEventImpl cloudEvent =
                new CloudProcessDeployedEventImpl(event.getEntity());
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }

    public CloudStartMessageDeployedEvent from(StartMessageDeployedEvent event) {
        CloudStartMessageDeployedEventImpl cloudEvent =
                CloudStartMessageDeployedEventImpl.builder().withEntity(event.getEntity()).build();
        runtimeBundleInfoAppender.appendRuntimeBundleInfoTo(cloudEvent);
        return cloudEvent;
    }
    ...
    public CloudBPMNErrorReceivedEvent from(BPMNErrorReceivedEvent event) {
        CloudBPMNErrorReceivedEventImpl cloudEvent =
