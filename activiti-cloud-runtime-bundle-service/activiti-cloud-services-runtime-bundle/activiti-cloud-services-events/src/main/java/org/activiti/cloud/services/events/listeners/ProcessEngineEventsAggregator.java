...
public class ProcessEngineEventsAggregator
        extends BaseCommandContextEventsAggregator<
                CloudRuntimeEvent<?, ?>, MessageProducerCommandContextCloseListener> {
    ...
    public void add(CloudRuntimeEvent<?, ?> element) {
        ...
        if (executionContext != null) {
            ExecutionContextInfoAppender executionContextInfoAppender =
                    createExecutionContextInfoAppender(executionContext);
    ...
    protected void mayBeAddRootExecutionContext(
            CommandContext commandContext, ExecutionEntity executionEntity) {
        ...
        if (rootExecutionContext == null && executionEntity.getRootProcessInstanceId() != null) {
            ExecutionEntity rootProcessInstance =
                    commandContext
    ...
    protected String resolveExecutionId(CloudRuntimeEvent<?, ?> element) {
        if (element instanceof CloudProcessRuntimeEvent) {
            ...
            return ((CloudMessageSubscriptionCancelledEvent) element)
                    .getEntity()
