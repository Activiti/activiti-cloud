...
public class ProcessEngineEventsAggregator
    ...
    public ProcessEngineEventsAggregator(
    ...
    public void add(CloudRuntimeEvent<?, ?> element) {
        ...
        ExecutionContext executionContext = resolveExecutionContext(
            commandContext,
            executionId
        );
        ...
        if (executionContext != null) {
            ...
            CloudRuntimeEventImpl<?, ?> event =
                CloudRuntimeEventImpl.class.cast(element);

            element =
                executionContextInfoAppender.appendExecutionContextInfoTo(
                    event
                );
        }
    ...
    protected ExecutionContext resolveExecutionContext(
        CommandContext commandContext,
        String executionId
    ) {
        if (
            executionId != null &&
            commandContext.getGenericAttribute(executionId) == null
        ) {
    ...
    protected void mayBeAddRootExecutionContext(
        CommandContext commandContext,
    ...
    protected ExecutionContextInfoAppender createExecutionContextInfoAppender(
    ...
    protected String resolveExecutionId(CloudRuntimeEvent<?, ?> element) {
        if (element instanceof CloudProcessRuntimeEvent) {
            ...
            return (
                (VariableInstance) element.getEntity()
