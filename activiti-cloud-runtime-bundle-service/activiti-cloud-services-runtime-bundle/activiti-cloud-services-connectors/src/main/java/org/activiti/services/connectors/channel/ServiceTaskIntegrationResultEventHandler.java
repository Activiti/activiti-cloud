...
public class ServiceTaskIntegrationResultEventHandler {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(ServiceTaskIntegrationResultEventHandler.class);
    ...
    public void receive(IntegrationResult integrationResult) {
        ...
        List<Execution> executions =
                runtimeService.createExecutionQuery().executionId(executionId).list();
        if (integrationContextEntity != null) {
            ...
            if (executions.size() > 0) {
                ...
                if (execution.getActivityId().equals(integrationContext.getClientId())) {
                    ...
                    LOGGER.warn(
                            "Could not find matching activityId '{}' for integration result '{}'"
                                    + " with executionId '{}'",
