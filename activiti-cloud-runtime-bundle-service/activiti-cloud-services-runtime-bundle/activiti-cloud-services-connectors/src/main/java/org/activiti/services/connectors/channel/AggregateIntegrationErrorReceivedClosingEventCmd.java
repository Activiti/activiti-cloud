...
class AggregateIntegrationErrorReceivedClosingEventCmd extends CommandContextCloseListenerAdapter
        implements Command<Void> {

    private final AggregateIntegrationErrorReceivedEventCmd
