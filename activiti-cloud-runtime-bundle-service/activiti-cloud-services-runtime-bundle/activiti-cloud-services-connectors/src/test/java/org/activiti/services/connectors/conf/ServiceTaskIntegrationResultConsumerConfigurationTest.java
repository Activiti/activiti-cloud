...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE,
        properties = {
                "spring.cloud.stream.function.definition=integrationResultsConsumer"
        },
        classes = { Application.class })
@Import({ TestChannelBinderConfiguration.class })
@ActiveProfiles("binding")
class ServiceTaskIntegrationResultConsumerConfigurationTest {
    ...
    public void receive_should_setVariablesTriggerExecutionAndDeleteRelatedIntegrationContext() {
        ...
        Message<IntegrationResultImpl> message = new GenericMessage<>(new IntegrationResultImpl(new IntegrationRequestImpl(), integrationContext));
    ...
    public void receiveShouldSendIntegrationAuditEventWhenIntegrationAuditEventsAreEnabled() {
        ...
        Message<IntegrationResult> message = new GenericMessage<>(integrationResultEvent);
