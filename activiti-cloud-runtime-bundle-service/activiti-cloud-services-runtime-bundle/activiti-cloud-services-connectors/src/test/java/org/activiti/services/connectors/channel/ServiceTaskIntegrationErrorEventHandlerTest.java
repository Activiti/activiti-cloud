...
public class ServiceTaskIntegrationErrorEventHandlerTest {
    ...
    public void setUp() {
        ...
        when(executionQuery.executionId(EXECUTION_ID))
    ...
    public void should_propagateErrorAndAggregateEvent_when_clientIdMatches() {
        ...
        given(
            integrationContextService.findById(integrationContextEntity.getId())
        )
        ...
        verify(managementService)
            .executeCommand(commandArgumentCaptor.capture());
        ...
        assertThat(compositeCommand.getCommands().get(0))
            .isInstanceOf(PropagateCloudBpmnErrorCmd.class);
    ...
    public void should_AggregateEventButNotPropagateError_when_clientIdDoesNotMatch() {
        ...
        ExecutionEntity executionEntity = mock(ExecutionEntity.class);
        given(executionEntity.getActivityId())
            .willReturn("idDifferentFromExpected");
        ...
        assertThat(command)
            .isExactlyInstanceOf(
                AggregateIntegrationErrorReceivedEventCmd.class
            );
    }
