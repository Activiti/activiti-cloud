...
public class DelegateExecutionBuilder {
    ...
    public DelegateExecutionBuilder withProcessDefinitionId(
        String processDefinitionId
    ) {
        when(execution.getProcessDefinitionId())
            .thenReturn(processDefinitionId);
        return this;
    }

    public DelegateExecutionBuilder withProcessInstanceId(
    ...
    public DelegateExecutionBuilder withRootProcessInstanceId(
    ...
    public DelegateExecutionBuilder withProcessDefinitionKey(
    ...
    public DelegateExecutionBuilder withProcessDefinitionVersion(
        Integer processDefinitionVersion
    ) {
        when(processInstance.getProcessDefinitionVersion())
            .thenReturn(processDefinitionVersion);
        return this;
    }

    public DelegateExecutionBuilder withParentProcessInstanceId(
        String parentProcessInstanceId
    ) {
        when(processInstance.getParentProcessInstanceId())
            .thenReturn(parentProcessInstanceId);
        return this;
    }
}
