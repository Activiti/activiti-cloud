...
public class MessageSubscriptionCancelledEventMessageProducer
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(MessageSubscriptionCancelledEventMessageProducer.class);
    ...
    public void onEvent(@NonNull MessageSubscriptionCancelledEvent event) {
        ...
        MessageEventPayload messageEventPayload =
                MessageEventPayloadBuilder.messageEvent(messageSubscription.getEventName())
