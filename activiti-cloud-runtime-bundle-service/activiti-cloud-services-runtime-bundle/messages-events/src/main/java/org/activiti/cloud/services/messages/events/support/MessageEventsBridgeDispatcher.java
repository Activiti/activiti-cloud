...
public class MessageEventsBridgeDispatcher extends MessageEventsDispatcher {

    private final StreamBridge streamBridge;

    public MessageEventsBridgeDispatcher(StreamBridge streamBridge,
            BindingServiceProperties bindingServiceProperties) {
        super(null, bindingServiceProperties);
    ...
    public void dispatch(Message<?> message) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new MessageBridgeSenderTransactionSynchronization(dispatchMessage,
                streamBridge));
    }
