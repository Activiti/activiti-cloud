...
@EnableBinding({MessageEventsSource.class})
public class MessageEventsAutoConfiguration {
    ...
    public MessageEventsDispatcher messageEventsDispatcher(
        ...
        return new MessageEventsDispatcher(
                messageEventsSource.messageEventsOutput(), bindingServiceProperties);
    }
    ...
    public MessageSubscriptionEventMessageBuilderFactory
            messageSubscriptionEventMessageBuilderFactory(RuntimeBundleProperties properties) {
    ...
    public BpmnMessageReceivedEventMessageProducer throwMessageReceivedEventListener(
        ...
        return new BpmnMessageReceivedEventMessageProducer(
    ...
    public BpmnMessageWaitingEventMessageProducer throwMessageWaitingEventMessageProducer(
            MessageEventsDispatcher messageEventsDispatcher,
            BpmnMessageEventMessageBuilderFactory messageBuilderFactory) {
        return new BpmnMessageWaitingEventMessageProducer(
                messageEventsDispatcher, messageBuilderFactory);
    }
    ...
    public BpmnMessageSentEventMessageProducer bpmnMessageSentEventProducer(
            MessageEventsDispatcher messageEventsDispatcher,
            BpmnMessageEventMessageBuilderFactory messageBuilderFactory) {
        return new BpmnMessageSentEventMessageProducer(
                messageEventsDispatcher, messageBuilderFactory);
    }
    ...
    public StartMessageDeployedEventMessageProducer MessageDeployedEventMessageProducer(
        ...
        return new StartMessageDeployedEventMessageProducer(
                messageEventsDispatcher, messageBuilderFactory);
    }
    ...
    public MessageSubscriptionCancelledEventMessageProducer
        ...
        return new MessageSubscriptionCancelledEventMessageProducer(
                messageEventsDispatcher, messageBuilderFactory);
    }
}
