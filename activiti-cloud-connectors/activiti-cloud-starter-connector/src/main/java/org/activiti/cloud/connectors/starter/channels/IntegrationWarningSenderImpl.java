...
public class IntegrationWarningSenderImpl implements IntegrationWarningSender {

    private final StreamBridge streamBridge;
    private final IntegrationWarningChannelResolver resolver;

    public IntegrationWarningSenderImpl(StreamBridge streamBridge, IntegrationWarningChannelResolver resolver) {
        this.streamBridge = streamBridge;
        this.resolver = resolver;
    }

    @Override
    public void send(Message<IntegrationWarning> message) {
