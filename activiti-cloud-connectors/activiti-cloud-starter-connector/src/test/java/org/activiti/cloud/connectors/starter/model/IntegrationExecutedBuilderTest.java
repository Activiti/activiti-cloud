...
public class IntegrationExecutedBuilderTest {
    ...
    public void shouldBuildMessageWithHeaders() throws Exception {
        ...
        IntegrationError integrationError = new IntegrationErrorImpl(integrationRequestEvent, error);

        Message<CloudRuntimeEvent<?, ?>[]> message = IntegrationFailedBuilder.failureFor(integrationError, properties).buildMessage();
        ...
        Assertions.assertThat(message.getPayload()[0]).isInstanceOf(CloudIntegrationFailedEvent.class);
    }
}
