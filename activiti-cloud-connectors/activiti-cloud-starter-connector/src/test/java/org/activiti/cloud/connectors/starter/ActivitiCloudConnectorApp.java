...
@EnableBinding(
    { CloudConnectorConsumerChannels.class, ProcessRuntimeChannels.class }
)
public class ActivitiCloudConnectorApp implements CommandLineRunner {
    ...
    public void mockTypeIntegrationRequestEvents(IntegrationRequest event) {
        ...
        IntegrationResult integrationResultEvent = resultFor(
            event,
            connectorProperties
        )
    ...
    public void mockTypeIntegrationErrorSender(
    ...
    public void mockTypeIntegrationCloudBpmnErrorSender(
        IntegrationRequest integrationRequest
    ) {
        try {
    ...
    public void mockTypeIntegrationCloudBpmnErrorRootCauseSender(
        IntegrationRequest integrationRequest
    ) {
        try {
    ...
    public void mockTypeIntegrationCloudBpmnErrorMessageSender(
        IntegrationRequest integrationRequest
    ) {
        try {
            raiseErrorCause("Error code message");
    ...
    private void verifyEventAndCreateResults(IntegrationRequest event) {
        ...
        assertThat(event.getIntegrationContext().getProcessDefinitionId())
            .isNotNull();
        assertThat(event.getIntegrationContext().getProcessInstanceId())
            .isNotNull();
    }

    private Map<String, Object> createResultVariables(
        IntegrationRequest integrationRequest
    ) {
