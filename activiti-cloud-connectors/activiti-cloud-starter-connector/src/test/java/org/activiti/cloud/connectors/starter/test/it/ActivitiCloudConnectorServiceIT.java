...
public class ActivitiCloudConnectorServiceIT {
    ...
    @Test
    public void integrationEventShouldBePickedByConnectorMock()
        throws Exception {
        //given
        ...
        await("Should receive at least 2 integration results")
            .untilAsserted(() ->
                assertThat(
                    streamHandler.getIntegrationResultEventsCounter().get()
                )
    ...
    @Test
    public void integrationErrorShouldBeProducedByConnectorRuntimeExceptionMock()
        throws Exception {
        //given
        ...
        assertThat(integrationError.getErrorClassName())
            .isEqualTo("java.lang.RuntimeException");
        assertThat(integrationError.getErrorMessage())
            .isEqualTo("Mock RuntimeException");
        assertThat(integrationError.getStackTraceElements())
            .asList()
            .isNotEmpty();
        assertThat(integrationError.getIntegrationContext().getId())
            .isEqualTo(INTEGRATION_ID);
    }

    @Test
    public void integrationErrorShouldBeProducedByConnectorErrorMock()
        throws Exception {
        //given
        streamHandler.isIntegrationErrorEventProduced().set(false);
    ...
    public void integrationErrorShouldBeProducedByConnectorCloudBpmnErrorCauseMock()
        ...
        await(
            "Should produce CloudBpmnError with root cause and message integration error"
        )
            .untilTrue(streamHandler.isIntegrationErrorEventProduced());
        ...
        assertThat(integrationError.getErrorClassName())
            .isEqualTo(CloudBpmnError.class.getName());
        assertThat(integrationError.getErrorCode()).isEqualTo("ERROR_CODE");
        assertThat(integrationError.getErrorMessage())
            .isEqualTo("Error cause message");
        assertThat(integrationError.getStackTraceElements())
            .asList()
            .isNotEmpty()
    ...
    public void integrationErrorShouldBeProducedByConnectorCloudBpmnErrorMessageMock()
        ...
        await(
            "Should produce CloudBpmnError with error code and message integration error"
        )
            .untilTrue(streamHandler.isIntegrationErrorEventProduced());
    ...
    @Test
    public void integrationErrorShouldBeProducedByConnectorCloudBpmnErrorMock()
        throws Exception {
        //given
        streamHandler.isIntegrationErrorEventProduced().set(false);
