...
import org.activiti.cloud.connectors.starter.bindings.IntegrationEventsProducer;
...
public class ActivitiCloudConnectorServiceIT {
    ...
    @Autowired
    private IntegrationEventsProducer integrationEventsProducer;
    ...
    public void setUp() throws Exception {
        ...
        Function<?, ?> router = functionRegistry.lookup("functionRouter");
        ...
        assertThat(integrationError.getStackTraceElements()).asList()
                                                            ...
                                                            .anyMatch(element ->
                                                                String.valueOf(element)
                                                                    .matches(".*(mockTypeIntegrationCloudBpmnErrorRootCauseSenderConsumer).*"));
    ...
    public void integrationErrorShouldBeProducedByConnectorCloudBpmnErrorMessageMock() throws Exception {
        ...
        assertThat(integrationError.getStackTraceElements()).asList()
                                                            ...
                                                            .anyMatch(element ->
                                                                String.valueOf(element)
                                                                    .matches(".*(mockTypeIntegrationCloudBpmnErrorMessageSenderConsumer).*"))
