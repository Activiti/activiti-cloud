...
@Component
@EnableBinding(
    { RuntimeMockStreams.class, MockCloudRuntimeEventsChannels.class }
)
public class ConnectorsITStreamHandlers {
    ...
    public void consumeIntegrationResultsMock(
        ...
        assertThat(
            ...
            .isEqualTo(2L);
        assertThat(integrationResult.getIntegrationContext().getId())
            .isEqualTo(getIntegrationId());
