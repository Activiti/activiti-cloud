...
public class ConnectorsITStreamHandlers {
    ...
    private static AtomicReference<IntegrationError> integrationErrorReference =
            new AtomicReference<>();
    ...
    public void consumeIntegrationResultsMock(IntegrationResult integrationResult)
        ...
        assertThat(integrationResult.getIntegrationContext().getOutBoundVariables().get("var2"))
                .isEqualTo(2L);
