...
import static org.activiti.engine.delegate.event.ActivitiEventType.ENGINE_CREATED;
...
@Component
public class ProcessCreatedEventConverter extends AbstractEventConverter {
    ...
    public ProcessEngineEvent from(ActivitiEvent event) {
        return new ProcessCreatedEventImpl(getRuntimeBundleProperties().getAppName(),
    ...
    public String handledType() {
        return "ProcessInstance:" + ENTITY_CREATED.toString();
    }
}
