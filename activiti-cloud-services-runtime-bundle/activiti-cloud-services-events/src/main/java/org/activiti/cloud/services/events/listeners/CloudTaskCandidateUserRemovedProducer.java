...
public class CloudTaskCandidateUserRemovedProducer implements TaskCandidateEventListener<TaskCandidateUserRemoved> {
    ...
    @Override
    public void onEvent(TaskCandidateUserRemoved event) {
