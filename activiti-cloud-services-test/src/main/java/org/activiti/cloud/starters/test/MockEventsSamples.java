...
import org.activiti.cloud.starters.test.builder.MockIntegrationEventBuilder;
...
public class MockEventsSamples {
    ...
    public static List<ProcessEngineEvent> allSupportedEvents() {
        ...
        coveredEvents.add(new MockProcessEngineEvent(System.currentTimeMillis(),
                                                     ...
                                                     "32",
                                                     "51"));
        coveredEvents.add(MockIntegrationEventBuilder.anIntegrationRequestSentEvent()
                                  .withExecutionId("21")
                                  .withProcessDefinitionId("33")
                                  .withProcessInstanceId("52")
                                  .withFlowNodeId("serviceTask")
                                  .build());
        coveredEvents.add(MockIntegrationEventBuilder.anIntegrationResultRecievedEvent()
                                  .withExecutionId("22")
                                  .withProcessDefinitionId("33")
                                  .withProcessInstanceId("52")
                                  .withFlowNodeId("serviceTask")
