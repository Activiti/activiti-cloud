...
public class ModelingProjectsSteps extends ModelingContextSteps<Project> {
    ...
    public void findByName(String name) {
        modelingContextHandler.setCurrentProjects(
            service().findAllByName(name).getContent()
        );
    }
    ...
    public void updateProjectName(String newProjectName) {
        EntityModel<Project> currentContext = checkAndGetCurrentContext(
            Project.class
        );
        ...
        modelingProjectService.updateByUri(
            modelingUri(currentContext.getLink(SELF).get().getHref()),
            project
        );
    }
    ...
    public void checkCurrentProjectName(String projectName) {
        ...
        assertThat(currentContext.getContent().getName())
    ...
    public EntityModel<Model> importModelInCurrentProject(File file) {
        EntityModel<Project> currentProject = checkAndGetCurrentContext(
            Project.class
        );
        ...
        return modelingProjectService.importProjectModelByUri(
            modelingUri(importModelLink.getHref()),
            file
        );
    }
    ...
    @Step
    public void checkCurrentProjectExportNotFail(String errorMessage)
        throws IOException {
        Response response = exportCurrentProject();
        assertThat(response.status()).isEqualTo(SC_OK);
        modelingContextHandler.setCurrentModelingFile(toFileContent(response));
    ...
    @Step
    public void checkCurrentProjectValidationFails(String errorMessage)
        throws IOException {
        Response response = validateCurrentProject();
    ...
    private Response exportCurrentProject() {
        ...
        return modelingProjectService.exportProjectByUri(
            modelingUri(exportLink.getHref())
        );
    }
    ...
    private Response validateCurrentProject() {
        ...
        Link exportLink = currentProject.getLink("export").get();
        String validateLink = exportLink
            .getHref()
            .replace("/export", "/validate");
        assertThat(validateLink).isNotNull();
        return modelingProjectService.validateProjectByUri(
            modelingUri(validateLink)
        );
    }
    ...
    public void checkExportedProjectContainsModel(
        ...
        Project currentProject = checkAndGetCurrentContext(Project.class)
            .getContent();
            ...
            .hasValueSatisfying(fileContent ->
                assertThatFileContent(fileContent)
                    ...
                    .hasEntries(
                        ...
                        "/" +
                        toJsonFilename(
                            modelName + modelType.getExtensionsFileSuffix()
                        ),
                        modelType.getFolderName() +
                        "/" +
                        setExtension(
                    ...
                    .hasJsonContentSatisfying(
                        ...
                        jsonContent ->
                            jsonContent
                                .node("name")
                                .isEqualTo(currentProject.getName())
                    )
                    .hasJsonContentSatisfying(
                        modelType.getFolderName() +
                        "/" +
