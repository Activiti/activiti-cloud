...
public interface ModelContentConverter<T extends ModelContent> {
    ...
    /**
     * Converts the file content to the handled model content entity, sets the given id, and
     * converts back to a FileContent. If the id is already the expected one, it returns it
     * unchanged.
     *
     ...
     */
    default FileContent overrideModelId(
