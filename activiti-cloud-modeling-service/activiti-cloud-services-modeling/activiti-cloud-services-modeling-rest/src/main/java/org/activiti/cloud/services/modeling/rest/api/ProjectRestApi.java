...
public interface ProjectRestApi {
    ...
    String IMPORT_PROJECT_FILE_PARAM_DESCR =
    ...
    String PROJECT_NAME_PARAM_DESCR =
        "The name or part of the name to filter projects";
    ...
    String PROJECT_FILTERS_PARAM_DESCR =
        "The filter name to filter the returned projects";
    ...
    EntityModel<Project> createProject(
        @Parameter(
            description = CREATE_PROJECT_PARAM_DESCR
    ...
    EntityModel<Project> getProject(
        @Parameter(
            description = GET_PROJECT_ID_PARAM_DESCR,
            required = true
    ...
    EntityModel<Project> updateProject(
        @Parameter(
            description = UPDATE_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @Parameter(
            description = UPDATE_PROJECT_PARAM_DESCR
        ) @RequestBody Project project
    );
    ...
    void deleteProject(
        @Parameter(
            description = DELETE_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId
    );
    ...
    void exportProject(
        ...
        @Parameter(
            description = EXPORT_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
    ...
    EntityModel<Project> copyProject(
        @Parameter(
            description = COPY_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @Parameter(description = PROJECT_NAME_COPY_DESCR) @RequestParam(
            name = PROJECT_NAME_PARAM_NAME
        ) String name
    );
