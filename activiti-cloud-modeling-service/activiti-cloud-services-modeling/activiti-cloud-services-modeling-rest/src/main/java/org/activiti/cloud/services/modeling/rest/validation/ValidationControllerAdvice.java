...
public class ValidationControllerAdvice {
    ...
    public void initModelBinder(final WebDataBinder binder, final HttpServletRequest request) {
        binder.addValidators(new ModelPayloadValidator(isPost(request), new ModelNameValidator()));
    }

    @InitBinder("project")
    public void initProjectBinder(final WebDataBinder binder, final HttpServletRequest request) {
        binder.addValidators(new ProjectPayloadValidator(isPost(request), new ProjectNameValidator()));
    }
