...
public class ProjectController implements ProjectRestApi {
    ...
    public PagedModel<EntityModel<Project>> getProjects(
        ...
        return pagedCollectionModelAssembler.toModel(
                pageable,
                projectService.getProjects(pageable, name, filters),
    ...
    public EntityModel<Project> updateProject(
            @PathVariable String projectId, @RequestBody @Valid Project project) {
    ...
    public Project findProjectRepresentationById(String projectId) {
        return projectService
                .findProjectRepresentationById(projectId)
                .orElseThrow(
                        () -> new ResourceNotFoundException("Project not found: " + projectId));
    }
}
