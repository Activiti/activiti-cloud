...
public interface ModelRestApi {
    ...
    @Operation(
            ...
            description =
                    "Get the models associated with an project. Minimal information for each model"
                            + " is returned.")
    ...
    PagedModel<EntityModel<Model>> getModels(
            ...
            @Parameter(description = GET_MODELS_TYPE_PARAM_DESCR)
                    @RequestParam(MODEL_TYPE_PARAM_NAME)
                    String type,
            Pageable pageable);
    ...
    EntityModel<Model> getModel(
            @Parameter(description = GET_MODEL_ID_PARAM_DESCR, required = true) @PathVariable
                    String modelId);
    ...
    EntityModel<Model> updateModel(
            @Parameter(description = UPDATE_MODEL_ID_PARAM_DESCR, required = true) @PathVariable
                    String modelId,
    ...
    @ResponseStatus(NO_CONTENT)
    void deleteModel(
            @Parameter(description = DELETE_MODEL_ID_PARAM_DESCR, required = true) @PathVariable
                    String modelId);
    ...
    void exportModel(
            HttpServletResponse response,
            @Parameter(description = EXPORT_MODEL_ID_PARAM_DESCR, required = true) @PathVariable
                    String modelId,
    ...
    @ResponseStatus(NO_CONTENT)
    void validateModel(
            @Parameter(description = VALIDATE_MODEL_ID_PARAM_DESCR, required = true) @PathVariable
                    String modelId,
    ...
    @Operation(
            ...
            description =
                    "Get the models that has GLOBAL as scope. Minimal information for each model is"
                            + " returned.")
    ...
    @Operation(
            ...
            description =
                    "Get the model associated with the project updated. Minimal information for the"
                            + " model is returned.")
