...
public interface ModelRestApi {
    ...
    String GET_MODELS_PROJECT_ID_PARAM_DESCR =
    ...
    PagedModel<EntityModel<Model>> getModels(
        @Parameter(
            description = GET_MODELS_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @Parameter(description = GET_MODELS_TYPE_PARAM_DESCR) @RequestParam(
    ...
    EntityModel<Model> getModel(
        @Parameter(
            description = GET_MODEL_ID_PARAM_DESCR,
            required = true
    ...
    EntityModel<Model> createModel(
        @Parameter(
            description = CREATE_MODEL_PROJECT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String projectId,
        @Parameter(
            description = CREATE_MODEL_PARAM_DESCR
    ...
    EntityModel<Model> updateModel(
        @Parameter(
            description = UPDATE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
        @Parameter(
            description = UPDATE_MODEL_PARAM_DESCR
        ) @RequestBody Model model
    );
    ...
    void updateModelContent(
        ...
        @Parameter(description = UPDATE_MODEL_FILE_PARAM_DESCR) @RequestPart(
    ...
    void deleteModel(
        @Parameter(
            description = DELETE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId
    );
    ...
    void getModelContent(
        ...
        @Parameter(
            description = GET_MODEL_CONTENT_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId
    ) throws IOException;
    ...
    @PostMapping(
        path = "/projects/{projectId}/models/import",
    ...
    EntityModel<Model> importModel(
        ...
        @Parameter(description = IMPORT_MODEL_TYPE_PARAM_DESCR) @RequestParam(
            MODEL_TYPE_PARAM_NAME
        ) String type,
        @Parameter(description = IMPORT_MODEL_FILE_PARAM_DESCR) @RequestPart(
            UPLOAD_FILE_PARAM_NAME
        ) MultipartFile file
    ) throws IOException;
    ...
    void exportModel(
        HttpServletResponse response,
        @Parameter(
            description = EXPORT_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
    ...
    void validateModel(
        @Parameter(
            description = VALIDATE_MODEL_ID_PARAM_DESCR,
            required = true
        ) @PathVariable String modelId,
        ...
        @Parameter(
            description = VALIDATE_PROJECT_ID_PARAM_DESCR,
            required = false
        ) @RequestParam(
        ...
        @Parameter(
            description = MODEL_USED_PARAM_DESCR,
            required = false
        ) @RequestParam(
    ...
    void validateModelExtensions(
        ...
        @Parameter(
            description = VALIDATE_EXTENSIONS_FILE_PARAM_DESCR
    ...
    PagedModel<EntityModel<Model>> getGlobalModels(
        ...
        @Parameter(
            description = INCLUDE_ORPHANS_PARAM_DESCR,
            required = false
        ) @RequestParam(
