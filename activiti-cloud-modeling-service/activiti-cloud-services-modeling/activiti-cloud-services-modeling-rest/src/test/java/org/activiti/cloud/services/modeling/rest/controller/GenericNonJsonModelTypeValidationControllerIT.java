...
public class GenericNonJsonModelTypeValidationControllerIT {
    ...
    @Autowired ModelType genericNonJsonModelType;
    ...
    public void setUp() {
        ...
        genericNonJsonModel =
                modelRepository.createModel(
                        new ModelEntity(GENERIC_MODEL_NAME, genericNonJsonModelType.getName()));
    }
    ...
    public void testValidateModelContent() throws IOException {
        ...
        given().multiPart("file", "simple-model.bin", fileContent, APPLICATION_OCTET_STREAM_VALUE)
    ...
    @Test
    public void
            sholud_callGnericNonJsonContentValidatorAndNotCallGnericNonJsonExtensionsValidator_when_validatingModelContentTextContentType()
                    throws IOException {
        byte[] fileContent = resourceAsByteArray("generic/model-simple.bin");

        given().multiPart("file", "simple-model.bin", fileContent, "text/plain")
                .post("/v1/models/{modelId}/validate", genericNonJsonModel.getId())
                .then()
                .expect(status().isNoContent())
                .body(isEmptyString());
    ...
    @Test
    public void
            sholud_callGnericNonJsonContentValidatorAndNotCallGnericNonJsonExtensionsValidator_when_validatingModelContentJsonContentType()
                    throws IOException {
    ...
    @Test
    public void
            sholud_throwExceptionAndCallGnericNonJsonContentValidatorAndNotCallGnericNonJsonExtensionsValidator_when_validatingInvalidModelContent()
                    throws IOException {
    ...
    @Test
    public void
            sholud_notCallGnericNonJsonContentValidatorAndCallGnericNonJsonExtensionsValidator_when_validatingModelValidExtensions()
                    throws IOException {
