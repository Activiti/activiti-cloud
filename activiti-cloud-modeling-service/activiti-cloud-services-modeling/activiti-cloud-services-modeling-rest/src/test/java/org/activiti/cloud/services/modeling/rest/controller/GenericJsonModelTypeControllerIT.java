...
public class GenericJsonModelTypeControllerIT {
    ...
    @Test
    public void should_update_when_creatingGenericJsonModelWithNameWithUnderscore() throws Exception {
    ...
    @Test
    public void should_update_when_creatingGenericJsonModelWithNameWithUppercase() throws Exception {
