...
public class GenericJsonModelTypeValidationControllerIT {
    ...
    public void sholud_callGenericJsonContentValidatorAndNotCallGenericJsonExtensionsValidator_when_validatingModelContentJsonContentType()
        ...
        verify(genericJsonContentValidator, times(1))
            .validateModelContent(
                argThat(content ->
                    new String(content).equals(new String(fileContent))
                ),
    ...
    public void sholud_notCallGenericJsonContentValidatorAndCallGenericJsonExtensionsValidator_when_validatingModelValidExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-valid-extensions.json"
        );
        ...
        verify(genericJsonContentValidator, times(0))
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-invalid-extensions.json"
        );
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidNameExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-invalid-name-extensions.json"
        );
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelMismatchNameExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-mismatch-name-extensions.json"
        );
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelLongNameExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-long-name-extensions.json"
        );
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelEmptyNameExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-empty-name-extensions.json"
        );
    ...
    public void sholud_throwSyntacticValidationException_when_validatingInvalidJsonExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-invalid-json-extensions.json"
        );
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidTypeExtensions()
        throws IOException {
        byte[] fileContent = resourceAsByteArray(
            "generic/model-simple-invalid-type-extensions.json"
        );
