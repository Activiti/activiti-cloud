...
public class GenericJsonModelTypeValidationControllerIT {
    ...
    @Autowired JsonModelType genericJsonModelType;
    ...
    private void validateInvalidContent() {
        SemanticModelValidationException exception =
                new SemanticModelValidationException(
                        Collections.singletonList(
                                new ModelValidationError(
                                        "Content invalid", "The content is invalid!!")));

        doThrow(exception)
                .when(genericJsonContentValidator)
                .validateModelContent(any(byte[].class), any(ValidationContext.class));
    }
    ...
    private void validateInvalidExtensions() {
        SemanticModelValidationException exception =
                new SemanticModelValidationException(
                        Collections.singletonList(
                                new ModelValidationError(
                                        "Extensions invalid", "The extensions are invalid!!")));
    ...
    @Test
    public void
            sholud_callGenericJsonContentValidatorAndNotCallGenericJsonExtensionsValidator_when_validatingModelContentJsonContentType()
                    throws IOException {
        byte[] fileContent = resourceAsByteArray("generic/model-simple.json");

        given().multiPart("file", "simple-model.json", fileContent, "application/json")
    ...
    @Test
    public void
            sholud_callGenericJsonContentValidatorAndNotCallGenericJsonExtensionsValidator_when_validatingModelContentTextContentType()
                    throws IOException {
        byte[] fileContent = resourceAsByteArray("generic/model-simple.json");

        given().multiPart("file", "simple-model.json", fileContent, "text/plain")
                .post("/v1/models/{modelId}/validate", genericJsonModel.getId())
                .then()
                .expect(status().isNoContent())
                .body(isEmptyString());
    ...
    @Test
    public void
            sholud_throwExceptionAndCallGenericJsonContentValidatorAndNotCallGenericJsonExtensionsValidator_when_validatingInvalidModelContent()
                    throws IOException {
    ...
    @Test
    public void
            sholud_notCallGenericJsonContentValidatorAndCallGenericJsonExtensionsValidator_when_validatingModelValidExtensions()
                    throws IOException {
        byte[] fileContent = resourceAsByteArray("generic/model-simple-valid-extensions.json");

        given().multiPart("file", "simple-model-extensions.json", fileContent, "application/json")
    ...
    @Test
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidExtensions()
            throws IOException {
    ...
    @Test
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidNameExtensions()
            throws IOException {
        byte[] fileContent =
                resourceAsByteArray("generic/model-simple-invalid-name-extensions.json");
        ...
        assertThatResponse(
                ...
                .isSemanticValidationException()
                .hasValidationErrors(
                        "required key [id] not found", "required key [name] not found");
    ...
    public void sholud_throwSemanticValidationException_when_validatingModelMismatchNameExtensions()
            throws IOException {
        byte[] fileContent =
                resourceAsByteArray("generic/model-simple-mismatch-name-extensions.json");
    ...
    @Test
    public void sholud_throwSemanticValidationException_when_validatingModelLongNameExtensions()
            throws IOException {
        ...
        assertThatResponse(
                ...
                .hasValidationErrors(
                        ...
                        "string [alfresco-adf-app-deployment-develop] does not match pattern"
                                + " ^[a-z]([-a-z0-9]{0,24}[a-z0-9])?$");
    ...
    @Test
    public void sholud_throwSemanticValidationException_when_validatingModelEmptyNameExtensions()
            throws IOException {
    ...
    @Test
    public void sholud_throwSyntacticValidationException_when_validatingInvalidJsonExtensions()
            throws IOException {
        byte[] fileContent =
                resourceAsByteArray("generic/model-simple-invalid-json-extensions.json");
    ...
    @Test
    public void sholud_throwSemanticValidationException_when_validatingModelInvalidTypeExtensions()
            throws IOException {
        byte[] fileContent =
                resourceAsByteArray("generic/model-simple-invalid-type-extensions.json");
    ...
    @Test
    public void sholud_throwException_when_validatingModelInvalidSemanticExtensions()
            throws IOException {
    ...
    @Test
    public void
            should_throwExceptionAndCallGenericJsonContentUsageValidatorA_when_validatingInvalidModelContent()
                    throws IOException {
        SemanticModelValidationException exception =
                new SemanticModelValidationException(
                        Collections.singletonList(
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        "application/json")
                                .post(
                                        "/v1/models/{modelId}/validate?validateUsage=true",
                                        genericJsonModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
                .isSemanticValidationException()
