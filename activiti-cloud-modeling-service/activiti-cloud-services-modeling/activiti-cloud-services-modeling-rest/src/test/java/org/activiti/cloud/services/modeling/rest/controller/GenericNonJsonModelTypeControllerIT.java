...
public class GenericNonJsonModelTypeControllerIT {
    ...
    @Test
    public void should_returnStatusCreatedAndModelName_when_creatingGenericNonJsonModel()
            throws Exception {
                        ...
                        post("/v1/projects/{projectId}/models", project.getId())
                                ...
                                .content(
                                        objectMapper.writeValueAsString(
                                                new ModelEntity(
                                                        name, genericNonJsonModelType.getName()))))
                .andExpect(status().isCreated())
                .andExpect(jsonPath("$.name", equalTo(GENERIC_MODEL_NAME)));
    }

    @Test
    public void should_throwRequiredFieldException_when_creatingGenericNonJsonModelWithNameNull()
            throws Exception {
        String name = null;
    ...
    @Test
    public void should_throwEmptyNameException_when_creatingGenericNonJsonModelWithNameEmpty()
            throws Exception {
        String name = "";
    ...
    @Test
    public void should_throwTooLongNameException_when_creatingGenericNonJsonModelWithNameTooLong()
            throws Exception {
        ...
        assertThatResponse(resultActions.andReturn())
                ...
                .hasValidationErrorMessages(
                        "The model name length cannot be greater than 26:"
                                + " '123456789_123456789_1234567'");
    }

    @Test
    public void should_update_when_creatingGenericNonJsonModelWithNameWithUnderscore()
            throws Exception {
    ...
    @Test
    public void should_create_when_creatingGenericNonJsonModelWithNameWithUppercase()
            throws Exception {
    ...
    @Test
    public void should_returnStatusOKAndModelName_when_updatingGenericNonJsonModel()
            throws Exception {
        String name = "updated-connector-name";

        Model genericNonJsonModel =
    ...
    @Test
    public void should_returnStatusOKAndModelName_when_updatingGenericNonJsonModelWithNameNull()
            throws Exception {
        String name = null;
    ...
    @Test
    public void should_throwBadNameException_when_updatingGenericNonJsonModelWithNameEmpty()
            throws Exception {
        String name = "";
    ...
    @Test
    public void should_throwBadNameException_when_updatingGenericNonJsonModelWithNameTooLong()
            throws Exception {
        String name = "123456789_123456789_1234567";
    ...
    @Test
    public void should_update_when_updatingGenericNonJsonModelWithNameWithUnderscore()
            throws Exception {
        String name = "name_with_underscore";
    ...
    @Test
    public void should_update_when_updatingGenericNonJsonModelWithNameWithUppercase()
            throws Exception {
        String name = "NameWithUppercase";
    ...
    @Test
    public void
            should_returnStatusCreatedAndNullExtensions_when_creatingGenericNonJsonModelWithNullExtensions()
                    throws Exception {
        Project project = projectRepository.createProject(project(GENERIC_PROJECT_NAME));
    ...
    @Test
    public void
            should_returnStatusCreatedAndNotNullExtensions_when_creatingGenericNonJsonModelWithEmptyExtensions()
                    throws Exception {
        Project project = projectRepository.createProject(project(GENERIC_PROJECT_NAME));
    ...
    @Test
    public void
            should_returnStatusCreatedAndExtensions_when_creatingGenericNonJsonModelWithValidExtensions()
                    throws Exception {
        Project project = projectRepository.createProject(project(GENERIC_PROJECT_NAME));
