...
public class ConnectorValidationControllerIT {
    ...
    @Test
    public void should_returnStatusNoContent_when_validatingConnectorTextContentType()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
    ...
    @Test
    public void should_returnStatusNoContent_when_validatingConnectorWithEvents()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
    ...
    @Test
    public void should_throwSemanticValidationException_when_validatingInvalidSimpleConnector()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-simple-connector.json"),
                                        "application/json")
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
    ...
    @Test
    public void should_throwSyntacticValidationException_when_validatingJsonInvalidConnector()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-json-connector.json"),
                                        "application/json")
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
    ...
    @Test
    public void
            should_throwSyntacticValidationException_when_validatingInvalidConnectorTextContentType()
                    throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
    ...
    public void should_throwSemanticValidationException_when_validatingInvalidConnectorNameTooLong()
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-connector-name-too-long.json"),
                                        "text/plain")
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
                ...
                .hasValidationErrors(
                        ...
                        "string [123456789_123456789_1234567] does not match pattern "
                                + DNS_LABEL_REGEX);
    }

    @Test
    public void should_throwSemanticValidationException_when_validatingInvalidConnectorNameEmpty()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-connector-name-empty.json"),
                                        "text/plain")
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
    ...
    @Test
    public void
            should_throwSemanticValidationException_when_validatingInvalidConnectorNameWithUnderscore()
                    throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-connector-name-with-underscore.json"),
                                        "text/plain")
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
                .isSemanticValidationException()
                .hasValidationErrors(
                        "string [name_with_underscore] does not match pattern " + DNS_LABEL_REGEX);
    }

    @Test
    public void
            should_throwSemanticValidationException_when_validatingInvalidConnectorNameWithUppercase()
                    throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/invalid-connector-name-with-uppercase.json"),
                                        CONTENT_TYPE_JSON)
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
                .isSemanticValidationException()
                .hasValidationErrors(
                        "string [NameWithUppercase] does not match pattern " + DNS_LABEL_REGEX);
    }

    @Test
    public void
            should_returnStatusNoContent_when_validatingConnectorWithCustomTypesInEventsAndActions()
                    throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
    ...
    @Test
    public void should_returnStatusNoContent_when_validatingConnectorWithErrors()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
    ...
    @Test
    public void
            should_throwSemanticValidationException_when_validatingInvalidConnectorErrorInvalidProperty()
                    throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
        ...
        assertThatResponse(
                        given().multiPart(
                                        ...
                                        resourceAsByteArray(
                                                "connector/connector-with-errors-invalid-property.json"),
                                        CONTENT_TYPE_JSON)
                                .post("/v1/models/{modelId}/validate", connectorModel.getId())
                                .then()
                                .expect(status().isBadRequest()))
    ...
    @Test
    public void should_returnStatusNoContent_when_validatingConnectorEventWithModel()
            throws IOException {
        final Model connectorModel = modelRepository.createModel(connectorModel("connector-name"));
