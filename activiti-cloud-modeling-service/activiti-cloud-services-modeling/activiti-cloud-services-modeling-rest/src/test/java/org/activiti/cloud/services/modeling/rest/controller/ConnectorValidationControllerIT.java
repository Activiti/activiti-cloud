...
public class ConnectorValidationControllerIT {
    ...
    @Test
    public void should_returnStatusNoContent_when_validatingSimpleConnector()
        throws IOException {
        final Model connectorModel = modelRepository.createModel(
            connectorModel("connector-name")
        );
    ...
    public void should_throwSemanticValidationException_when_validatingInvalidConnectorNameWithUnderscore()
        ...
        assertThatResponse(
            ...
            .isSemanticValidationException()
            .hasValidationErrors(
                "string [name_with_underscore] does not match pattern " +
                DNS_LABEL_REGEX
            );
    }
    ...
    public void should_throwSemanticValidationException_when_validatingInvalidConnectorNameWithUppercase()
        ...
        assertThatResponse(
            ...
            .isSemanticValidationException()
            .hasValidationErrors(
                "string [NameWithUppercase] does not match pattern " +
                DNS_LABEL_REGEX
            );
    }
    ...
    public void should_returnStatusNoContent_when_validatingConnectorWithCustomTypesInEventsAndActions()
        ...
        given()
            .multiPart(
                ...
                resourceAsByteArray(
                    "connector/connector-with-custom-type.json"
                ),
                "text/plain"
            )
            .post("/v1/models/{modelId}/validate", connectorModel.getId())
    ...
    public void should_returnStatusNoContent_when_validatingConnectorEventWithModel()
        ...
        given()
            .multiPart(
                ...
                resourceAsByteArray(
                    "connector/connector-with-event-model.json"
                ),
                "text/plain"
            )
            .post("/v1/models/{modelId}/validate", connectorModel.getId())
