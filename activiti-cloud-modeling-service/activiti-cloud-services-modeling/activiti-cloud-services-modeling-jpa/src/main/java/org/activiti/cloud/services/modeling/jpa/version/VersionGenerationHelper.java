...
public class VersionGenerationHelper<
    T extends VersionedEntity, V extends VersionEntity
> {
    ...
    public VersionGenerationHelper(
    ...
    public void generateNextVersion(T versionedEntity) {
        String nextVersion = versionGenerator.generateNextVersion(
            versionedEntity.getLatestVersion()
        );
        ...
        try {
            ...
            throw new DataIntegrityViolationException(
                String.format(
                    "Invalid version class %s: No copy constructor declared",
                    versionClass
                ),
                e
            );
