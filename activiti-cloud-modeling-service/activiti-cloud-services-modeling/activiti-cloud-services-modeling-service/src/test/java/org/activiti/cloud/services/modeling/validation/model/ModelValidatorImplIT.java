...
class ModelValidatorImplIT {
    ...
    void should_validateWithOneError_when_validateWithInvalidDNSName() {
        ...
        executeValidateMethodTest(model, "The model name should follow DNS-1035 conventions:"
    ...
    private void executeValidateMethodTest(Model model, String expected) {
        Stream<ModelValidationError> validationResult = this.modelNameValidator.validate(
            model);
