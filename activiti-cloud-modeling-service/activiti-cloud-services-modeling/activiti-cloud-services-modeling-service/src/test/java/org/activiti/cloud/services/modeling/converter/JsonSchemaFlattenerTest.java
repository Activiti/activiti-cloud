...
public class JsonSchemaFlattenerTest {
    ...
    public void should_flattenSchemaShouldAddDefiniitons_when_noDefinitionsPresent()
        ...
        JSONObject schema =
                getTestJSONObjectWithoutDefinitions(
    ...
    public void should_flattenSchemaShouldAddSection_when_definitionsArePresent()
        ...
        JSONObject schema =
                getTestJSONObjectWithDefinitions("classpath://schema/model-extensions-schema.json");
        assertThat(schema).isNotNull();

        String sectionName =
                flattener.getSectionNameFromFileName("schema/model-extensions-schema.json");
    ...
    private JSONObject getSchemaFromResource(String schemaFileName) throws IOException {
        ...
        return new JSONObject(
                new JSONTokener(new ClassPathResource(schemaFileName).getInputStream()));
    }
