 ...
 */
public class TaskMappingsServiceTaskImplementationValidator
    implements TaskMappingsValidator {
    ...
    public Stream<ModelValidationError> validateTaskMappings(
        ...
        Map<String, ConnectorModelFeature> availableConnectorActions = getAvailableConnectorActions(
            validationContext
        );
        ...
        return taskMappings
            .stream()
            .flatMap(taskMapping ->
                validateTaskMapping(taskMapping, availableConnectorActions)
            );
    }
    ...
    private Stream<ModelValidationError> validateTaskMapping(
        ...
        Optional<String> implementationTask = getTaskImplementation(
            ...
            return getTaskImplementation(task)
                ...
                .flatMap(action ->
                    Optional
                        ...
                        .filter(parameter ->
                            parameter.equals(connectorParameterName)
                        )
                        .findFirst()
