...
public class BpmnModelUniqueIdValidator implements BpmnCommonModelValidator {
    ...
    public static final String DUPLICATED_PROCESS_ID_ERROR_DESCRIPTION =
    ...
    public BpmnModelUniqueIdValidator(
    ...
    public Stream<ModelValidationError> validate(BpmnModel bpmnModel, ValidationContext validationContext) {
        ...
        duplicatedProcesses
            .stream()
            .forEach(process ->
                aggregatedErrors.add(
                    createModelValidationError(
                        DUPLICATED_PROCESS_ID_ERROR,
    ...
    private List<Process> getAllBpmnProcesses(ValidationContext validationContext) {
        return validationContext
            ...
            .flatMap(currentModel -> currentModel.getProcesses().stream())
            .collect(Collectors.toList());
    }
}
