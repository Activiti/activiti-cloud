...
public class StartEventIncomingOutgoingFlowValidator
    implements FlowNodeFlowsValidator {

    public static final String NO_OUTGOING_FLOW_PROBLEM =
    ...
    public static final String INCOMING_FLOW_ON_START_EVENT_PROBLEM =
    ...
    public static final String START_EVENT_FLOWS_VALIDATOR_NAME =
