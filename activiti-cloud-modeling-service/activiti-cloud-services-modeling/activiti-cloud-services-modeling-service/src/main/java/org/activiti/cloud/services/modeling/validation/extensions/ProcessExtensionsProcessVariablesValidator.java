 ...
 */
public class ProcessExtensionsProcessVariablesValidator
    ...
    public Stream<ModelValidationError> validateExtensions(
        ...
        Set<String> availableProcessVariables = getAvailableProcessVariables(
            extensions
        );
    ...
    private Optional<ModelValidationError> validateProcessVariableMapping(
        ...
        Object variableName = action == INPUTS
            ? processVariableMapping.getValue()
            : processVariableMappingKey;
        return (
                processVariableMapping.getType() == VARIABLE &&
