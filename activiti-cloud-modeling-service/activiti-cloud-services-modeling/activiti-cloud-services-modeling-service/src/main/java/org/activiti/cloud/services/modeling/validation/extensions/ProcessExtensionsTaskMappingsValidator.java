 ...
 */
public class ProcessExtensionsTaskMappingsValidator
    implements ProcessExtensionsValidator {
    ...
    private Map<String, Constant> getTaskConstants(
        Extensions extensions,
        String taskKey
    ) {
        return extensions.getConstants() != null
            ? extensions.getConstants().get(taskKey)
            : null;
    }
    ...
    private Stream<ModelValidationError> validateTaskMappings(
        ...
        List<MappingModel> taskMappings = toTaskMappings(
            processId,
            task,
            taskMappingsMap
        );
