...
public class JsonConverterConfiguration {
    ...
    @Bean
    public JsonConverter<Project> projectJsonConverter(
    ...
    @Bean
    public JsonConverter<ProjectDescriptor> projectDescriptorJsonConverter(
        ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public JsonConverter<ConnectorModelContent> connectorModelContentJsonConverter(
        ObjectMapper objectMapper
    ) {
    ...
    @Bean
    public JsonConverter<Extensions> jsonExtensionsConverter(
        ObjectMapper objectMapper
    ) {
