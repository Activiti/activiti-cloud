...
public class BpmnModelCallActivityValidator
    ...
    private final String XML_CONTENT_NOT_PRESEND =
        "Xml content for the model is not present";
    private final String XML_NOT_PARSABLE =
        "Xml content for the model is not valid.";
    ...
    private Stream<String> retrieveProcessIdFromModel(Model model)
    ...
    private Stream<ModelValidationError> evaluateProcessCallActivity(
        ...
        Set<CallActivity> availableActivities = converter.findAllNodes(
            CallActivity.class
        );
