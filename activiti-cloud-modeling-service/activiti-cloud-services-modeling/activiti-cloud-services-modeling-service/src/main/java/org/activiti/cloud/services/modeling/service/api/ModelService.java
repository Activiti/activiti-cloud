...
public interface ModelService {
    ...
    Optional<ModelContent> createModelContentFromModel(
        Model model,
        FileContent fileContent
    );

    Model importSingleModel(
        Project project,
        ModelType modelType,
        FileContent fileContent
    );
    ...
    Optional<String> contentFilenameToModelName(
        String filename,
        ModelType modelType
    );
