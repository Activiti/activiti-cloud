...
public class ProjectHolder {
    ...
    public ProjectHolder addModelJsonFile(
    ...
    public Optional<FileContent> getModelExtension(Model model) {
        return Optional.ofNullable(model.getName())
                .map(name -> key(name, model.getType()))
