 ...
 */
public class ConnectorModelContentConverter
    implements ModelContentConverter<ConnectorModelContent> {
    ...
    public ConnectorModelContentConverter(
        ...
        this.connectorModelContentJsonConverter =
    ...
    public Optional<ConnectorModelContent> convertToModelContent(byte[] bytes) {
        return Optional.ofNullable(
            connectorModelContentJsonConverter.convertToEntity(bytes)
        );
    }

    @Override
    public byte[] convertToBytes(ConnectorModelContent connectorModelContent) {
        return connectorModelContentJsonConverter.convertToJsonBytes(
    ...
    private void updateConnectorIdFromFileContent(
        ObjectNode jsonNode,
        Map<String, String> modelIdentifiers
    ) {
        String actualId = jsonNode.get("id") != null
            ? modelIdentifiers.get(jsonNode.get("id").asText())
            : null;
        if (actualId != null) {
