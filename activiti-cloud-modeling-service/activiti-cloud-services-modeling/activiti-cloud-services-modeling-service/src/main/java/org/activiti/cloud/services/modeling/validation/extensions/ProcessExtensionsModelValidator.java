...
public class ProcessExtensionsModelValidator
    ...
    protected Stream<ModelValidationError> validateBpmnModel(
        ...
        return bpmnModel
            ...
            .stream()
            .map(process ->
                this.retrieveExtensionByProcessId(model, process.getId())
            )
            .flatMap(extensions ->
                validateProcessExtension(
                    extensions,
                    validationContext,
                    bpmnModel
                )
    ...
    private Map<String, Object> retrieveExtensionByProcessId(
        Model model,
        String processId
    ) {
        return (
