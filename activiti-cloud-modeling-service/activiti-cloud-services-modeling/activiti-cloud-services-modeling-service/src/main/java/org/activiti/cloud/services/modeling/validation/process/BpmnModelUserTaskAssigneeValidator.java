 ...
 */
public class BpmnModelUserTaskAssigneeValidator
    implements BpmnCommonModelValidator {

    private static final String NO_ASSIGNEE_PROBLEM_TITLE =
    ...
    private static final String USER_TASK_ASSIGNEE_VALIDATOR_NAME =
        "BPMN user task assignee validator";

    private final FlowElementsExtractor flowElementsExtractor;

    public BpmnModelUserTaskAssigneeValidator(
    ...
    private Optional<ModelValidationError> validateTaskAssignedUser(
        UserTask userTask
    ) {
        if (
            !(
