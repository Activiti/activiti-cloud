...
public class BpmnModelSequenceFlowValidator implements BpmnModelValidator {
    ...
    public static final String NO_SOURCE_REF_PROBLEM_DESCRIPTION = "Sequence flow id: '%s', name: '%s' has to have a source reference";
    public static final String NO_TARGET_REF_PROBLEM = "Sequence flow has no target reference";
    public static final String NO_TARGET_REF_PROBLEM_DESCRIPTION = "Sequence flow id: '%s', name: '%s' has to have a target reference";
