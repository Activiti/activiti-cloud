...
public class TaskEventContainedBuilder {
    ...
    public Task aCreatedStandaloneAssignedTaskWithParent(
        String taskName,
        String username
    ) {
        Task task = buildTask(taskName, Task.TaskStatus.CREATED, null);
    ...
    public Task anAssignedTask(
        String taskName,
        String username,
        ProcessInstance processInstance
    ) {
        TaskImpl task = buildTask(
            taskName,
