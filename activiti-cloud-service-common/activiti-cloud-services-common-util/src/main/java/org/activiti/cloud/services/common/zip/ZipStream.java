...
public class ZipStream {
    ...
    public class ZipStreamEntry {
         ...
         * <p>
         *
         * <p>The {@code index} parameter is the index of the folder name to return. The the root
         * folder in the directory hierarchy has index {@code 0}.
         *
         * <p>If the zip entry is a file, will return {@literal Optional#empty()} for the index
         * value corresponding to the file name.
         *
         * @param index the index of the folder
         * @return the folder name corresponding to the given index, or {@literal Optional#empty()}
         *     if there is no folder for that index
         */
        ...
        /**
         * Get the file content for this zip entry. If this is not a file, this will return
