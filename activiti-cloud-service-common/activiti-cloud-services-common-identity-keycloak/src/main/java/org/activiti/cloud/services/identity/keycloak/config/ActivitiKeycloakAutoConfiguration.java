...
@ConditionalOnProperty(
    name = "activiti.cloud.services.keycloak.enabled",
    matchIfMissing = true
)
@EnableConfigurationProperties(
    { ActivitiKeycloakProperties.class, KeycloakProperties.class }
)
public class ActivitiKeycloakAutoConfiguration {
    ...
    public KeycloakUserGroupManager keycloakUserGroupManager(
    ...
    public KeycloakClientPrincipalDetailsProvider keycloakClientPrincipalDetailsProvider(
        ...
        return new KeycloakClientPrincipalDetailsProvider(
            keycloakInstanceWrapper
        );
    }
}
