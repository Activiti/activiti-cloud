...
public class OAuth2SecurityContextPrincipalProvider implements SecurityContextPrincipalProvider {
...
//
//    ((KeycloakPrincipal)Optional.ofNullable(SecurityContextHolder.getContext())
//        .map(SecurityContext::getAuthentication).get()
