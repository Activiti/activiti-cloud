...
/**
 * OIDC implementation for {@link SecurityContextTokenProvider}
 */
public class OAuth2SecurityContextTokenProvider implements SecurityContextTokenProvider {

    private OAuth2AuthorizedClientService auth2AuthorizedClientService;

    public OAuth2SecurityContextTokenProvider(OAuth2AuthorizedClientService auth2AuthorizedClientService) {
