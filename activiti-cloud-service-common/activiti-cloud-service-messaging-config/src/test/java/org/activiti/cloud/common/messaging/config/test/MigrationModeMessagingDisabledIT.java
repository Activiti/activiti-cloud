...
/**
 * Verifies that migration mode is disabled by default and no output channels are blocked.
 */
@SpringBootTest(
    properties = {
...
public class MigrationModeMessagingDisabledIT {
    ...
    @Test
    void migrationModeIsDisabledByDefault() {
        assertThat(messagingProperties.isMigrationMode()).isFalse();
    }

    @Test
    void drainHealthIndicatorIsNotRegisteredWhenMigrationModeIsDisabled() {
        assertThat(drainHealthIndicator).isNull();
    }
}
