...
public class ActivitiMessagingDestinationsEnvironmentPostProcessorIT {
    ...
    public void testBindingServicePropertiesDefaults() {
        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("commandConsumer")
                                .getDestination())
                .isEqualTo("quix.baz.commandconsumer.foo");
        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("messageConnectorOutput")
                                .getDestination())
                .isEqualTo("quix.baz.commandconsumer.foo");
        assertThat(bindingServiceProperties.getBindingProperties("commandConsumer").getGroup())
                .isEqualTo("bar");
    }
    ...
    public void testBindingServicePropertiesWithConnectorDestinationOverride() {
        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("camelConnectorConsumer")
                                .getDestination())
                .isEqualTo("quix.baz.camel_connector_invoke");

        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("camel-connector.INVOKE")
                                .getDestination())
                .isEqualTo("quix.baz.camel_connector_invoke");
    }
    ...
    public void testBindingServicePropertiesWithAsyncExecutorJobsOverride() {
        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("asyncExecutorJobsInput")
                                .getDestination())
                .isEqualTo("quix.baz.asyncexecutorjobs.foo");

        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("asyncExecutorJobsOutput")
                                .getDestination())
                .isEqualTo("quix.baz.asyncexecutorjobs.foo");
    }
    ...
    public void testBindingServicePropertiesWithMessageEventsOverrides() {
        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("messageEventsOutput")
                                .getDestination())
                .isEqualTo("quix.baz.message-events.foo");

        assertThat(
                        bindingServiceProperties
                                .getBindingProperties("messageConnectorInput")
                                .getDestination())
                .isEqualTo("quix.baz.message-events.foo");
    }
}
