...
public class PageMetadataConverter {
    ...
    public PaginationMetadata toAlfrescoPageMetadata(
        PagedModel.PageMetadata basePageMetadata,
        long count
    ) {
        long skipCount =
            basePageMetadata.getNumber() * basePageMetadata.getSize();
        if (basePageMetadata instanceof ExtendedPageMetadata) {
            skipCount =
                ((ExtendedPageMetadata) basePageMetadata).getSkipCount();
        }
