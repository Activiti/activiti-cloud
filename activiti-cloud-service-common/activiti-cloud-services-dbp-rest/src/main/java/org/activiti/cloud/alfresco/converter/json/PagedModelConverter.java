...
public class PagedModelConverter {
    ...
    public <T> ListResponseContent<T> pagedCollectionModelToListResponseContent(
        ...
        List<EntryResponseContent<T>> baseContent = getAlfrescoContentEntries(
    ...
    public <T> ListResponseContent<T> resourcesToListResponseContent(
        CollectionModel<EntityModel<T>> resources
    ) {
        return ListResponseContent.wrap(
            getAlfrescoContentEntries(resources),
            null
        );
    }
