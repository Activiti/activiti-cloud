...
public class ExtendedPageMetadataConverterTest {
    ...
    @Test
    public void getMetadataShouldReturnTotalPagesAsDivisionOfTotalElementsByPageSizeWhenNoRemainder()
        throws Exception {
        //given
        PagedModel.PageMetadata basePageMetadata = new PagedModel.PageMetadata(
            10,
            1,
            30
        );
        //when
        ExtendedPageMetadata extendedPageMetadata = converter.toExtendedPageMetadata(
            10,
            basePageMetadata
        );
