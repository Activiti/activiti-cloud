...
public class AlfrescoPageArgumentMethodResolverTest {
    ...
    @InjectMocks private AlfrescoPageArgumentMethodResolver alfrescoPageArgumentMethodResolver;

    @Mock private AlfrescoPageParameterParser pageParameterParser;
    ...
    public void resolveArgumentShouldReturnAPageableBasedOnParsedSkipCountAndMaxItems()
        ...
        given(webRequest.getParameterMap())
                .willReturn(Collections.singletonMap("skipCount", new String[] {"40"}));
        WebDataBinderFactory binderFactory = mock(WebDataBinderFactory.class);

        Pageable basePageable = mock(Pageable.class);
        given(
                        pageableHandlerMethodArgumentResolver.resolveArgument(
                                methodParameter, modelAndViewContainer, webRequest, binderFactory))
        ...
        Pageable resolvedPageable =
                alfrescoPageArgumentMethodResolver.resolveArgument(
                        methodParameter, modelAndViewContainer, webRequest, binderFactory);
