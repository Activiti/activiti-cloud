...
public class AlfrescoPageRequestParameterParserTest {
    ...
    private AlfrescoPageParameterParser pageParameterParser = new AlfrescoPageParameterParser(
        DEFAULT_PAGE_SIZE
    );

    @Test
    public void parseMaxItemsShouldReturnValueOfMaxItemsParameter()
        throws Exception {
        //given
        NativeWebRequest webRequest = buildRequest(MAX_ITEMS_KEY, "50");

        //when
        MaxItemsParameter maxItems = pageParameterParser.parseMaxItems(
            webRequest
        );
    ...
    @Test
    public void parseMaxItemsShouldReturnDefaultPageSizeWhenMaxItemsIsNotSet()
        throws Exception {
        //given
    ...
    @Test
    public void parseSkipCountShouldReturnValueOfSkipCountParameter()
        throws Exception {
        //given
        NativeWebRequest request = buildRequest(SKIP_COUNT_KEY, "200");

        //when
        SkipCountParameter skipCount = pageParameterParser.parseSkipCount(
            request
        );
    ...
    @Test
    public void parseSkipCountShouldReturnZeroWhenSkipCountIsNotSet()
        throws Exception {
        //given
    ...
    @Test
    public void parseParametersShouldParseSkipCountAndMaxItems()
        throws Exception {
        //given
        NativeWebRequest webRequest = mock(NativeWebRequest.class);
