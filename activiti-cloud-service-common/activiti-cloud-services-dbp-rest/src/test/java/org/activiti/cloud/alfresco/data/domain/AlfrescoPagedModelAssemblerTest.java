...
public class AlfrescoPagedModelAssemblerTest {
    ...
    @Test
    public void toResourceShouldReplaceBasePageMetadataByExtendedPageMetadata()
        throws Exception {
        //given
        ...
        PagedModel.PageMetadata baseMetadata = new PagedModel.PageMetadata(
            10,
            0,
            30
        );
        ...
        PagedModel<RepresentationModel> basePagedModel = PagedModel.of(
            Collections.singletonList(resourceSupport),
            baseMetadata,
            link
        );

        doReturn(basePagedModel)
            .when(alfrescoPagedModelAssembler)
            .toModel(page, resourceAssembler);
        ExtendedPageMetadata extendedPageMetadata = mock(
            ExtendedPageMetadata.class
        );
        given(
        ...
        assertThat(pagedCollectionModel.getMetadata())
            .isEqualTo(extendedPageMetadata);
        assertThat(pagedCollectionModel.getContent())
            .containsExactly(resourceSupport);
