...
public class JobStarter {
    ...
    public JobStarter(JobLocator jobLocator, JobRepository jobRepository, boolean addUniqueJobParameter, JobRegistry jobRegistry) {
    ...
    public JobExecution start(JobConfig jobConfig) {
        try {
            ...
            if (addUniqueJobParameter) params.put("uuid", new JobParameter(UUID.randomUUID().toString()));
