...
public class JobBuilder {
    ...
    public JobBuilder(final JobRegistry jobRegistry, final JobBuilderFactory jobs, final StepBuilderFactory steps, final Environment environment) {
    ...
    private Job createJob(String name, Tasklet tasklet) {
        return registerJob(jobs.get(name).incrementer(new RunIdIncrementer()).start(steps.get("step").allowStartIfComplete(true).tasklet(tasklet).build()).build());
    }
