...
public class JobExecutionControllerTest {
    ...
    public void jobExecutionById() throws Exception {
        ...
        mockMvc.perform(get("/v1/admin/batch/jobs/executions/" + Fixtures.je11.getId()))
    ...
    public void jobExecutionByIdNotFound() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions/" + 10))
    ...
    public void jobExecutions() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions"))
               .andExpect(status().isOk())
    ...
    public void successfulJobExecutions() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions?exitCode=COMPLETED"))
               .andExpect(status().isOk())
    ...
    public void failedJobExecutions() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions?exitCode=FAILED"))
               .andExpect(status().isOk())
               .andExpect(jsonPath("$..jobExecution", hasSize(3)));
    }
    ...
    public void successfulJobExecutionsPerJob() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions?jobName=j2&exitCode=COMPLETED"))
               .andExpect(status().isOk())
    ...
    public void successfulJobExecutionsPerJobAndLimited() throws Exception {
        mockMvc.perform(get("/v1/admin/batch/jobs/executions?jobName=j2&exitCode=COMPLETED&limitPerJob=1"))
               .andExpect(status().isOk())
               .andExpect(jsonPath("$..jobExecution", hasSize(1)));
    }
    ...
    public void jobFailsWithGenericException() throws Exception {
        ...
        mockMvc.perform(post("/v1/admin/batch/jobs/executions").contentType(APPLICATION_JSON).content("{\"name\":\"foo\"}"))
