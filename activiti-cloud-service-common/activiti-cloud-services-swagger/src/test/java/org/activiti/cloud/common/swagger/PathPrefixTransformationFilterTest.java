...
public class PathPrefixTransformationFilterTest {
    ...
    private PathPrefixTransformationFilter transformationFilter =
            new PathPrefixTransformationFilter("/base");

    @Mock private OpenApiTransformationContext<HttpServletRequest> context;
    ...
    private OpenAPI buildOpenAPI(String servicePrefix) {
        ...
        openAPI.setExtensions(
                Collections.singletonMap(SwaggerDocketBuilder.SERVICE_URL_PREFIX, servicePrefix));
    ...
    @Test
    public void
            transform_should_convertDoubleSlashToSingleSlash_when_concatenationResultsInDoubleSlash() {
        // given
        PathPrefixTransformationFilter transformationFilter =
                new PathPrefixTransformationFilter("/");
        final OpenAPI openAPI = buildOpenAPI("/service");
