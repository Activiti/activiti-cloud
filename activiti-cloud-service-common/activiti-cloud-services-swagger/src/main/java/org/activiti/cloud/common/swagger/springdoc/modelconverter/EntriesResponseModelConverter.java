...
import org.activiti.cloud.alfresco.rest.model.EntriesResponseContent;

import java.util.Iterator;

public class EntriesResponseModelConverter extends InternalModelConverter<EntriesResponseContent> {

    @Override
    protected boolean applies(JavaType javaType) {
        return javaType instanceof SimpleType && EntriesResponseContent.class.equals(javaType.getRawClass());
    }

    @Override
    protected Class<EntriesResponseContent> getAlternateTypeClass() {
        return EntriesResponseContent.class;
    }
